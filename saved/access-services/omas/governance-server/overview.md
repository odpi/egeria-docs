...
* [Open Survey Framework (OSF)](/frameworks/osf/overview) for Survey Action Services that analyse the content of resources in the digital landscape.
...
!!! info "Further documentation"
    ...
    - [Watchdog Action Services](/guides/developer/watch-action-services) for the time-based services.
