...
the **[open metadata repository cohort](/egeria-docs/concepts/cohort-member)**.  

Each server in the open metadata repository cohort has
a **[Cohort Registry](../services/omrs/component-descriptions/cohort-registry.md)** component to manage
