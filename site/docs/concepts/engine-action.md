...
Engine actions can be created through the [Open Governance Service API](/services/gaf-metadata-management). Some governance services (for example, the  [Watchdog Governance Action Service](/guides/developer/watchdog-action-services/overview)) can initiate other engine actions directly.  
