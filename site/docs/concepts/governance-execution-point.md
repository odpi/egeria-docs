...
A governance execution point is represented in open metadata by the [*ExecutionPoint* classification](/types/4/0460-Governance-Execution-Points), attached to the element that implements it.  Its *qualifiedName* attribute records the governance definition - usually a governance control - that the execution point supports.
