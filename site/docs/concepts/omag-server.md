...
- [Governance Server](/concepts/governance-server) - supports the use of metadata in the broader IT landscape.
    ...
    - [Integration Daemon](/concepts/integration-daemon) - manages the synchronization of metadata with third party technology that cannot call the [open metadata API](/services/omvs) directly.
