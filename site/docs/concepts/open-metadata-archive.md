...
??? education "Further information"
    ...
    - [Configuring a server to load an archive on start up](/guides/admin/servers/by-section/repository-services-section)
    ...
    - [The open metadata archive connector](/concepts/open-metadata-archive-store-connector) is the connector used to read and write open metadata archives.
