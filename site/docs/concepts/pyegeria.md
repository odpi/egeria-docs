...
* A [Python client](/guides/developer/python-clients/overview) supporting a collection of python functions for calling Egeria's [Open Metadata and Governance (OMAG) services](/services/omvs) from a python program - or programming environment, such as Jupyter notebooks.
