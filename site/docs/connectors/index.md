...
* [Open Lineage Event Receiver integration connector](/connectors/integration/open-lineage-event-receiver-integration-connector) receives open lineage events from an event topic and publish them to integration connectors with listeners registered in the same integration daemon server.                                                                                                              
...
* [Open Lineage Cataloguer integration connector](/connectors/integration/open-lineage-cataloguer-integration-connector)  registers an Open Lineage listener with the integration daemon and to catalog any processes that are not already known to the open metadata ecosystem.
