...
| [Cohort Registry Store Connectors](/concepts/cohort-registry-store-connector)               | store the [open metadata repository cohort](/concepts/cohort-member) membership details in the [cohort registry store](/concepts/cohort-registry-store-connector).               |
