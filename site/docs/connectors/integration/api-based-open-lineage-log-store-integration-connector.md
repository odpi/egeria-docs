...
This is its connection definition to use on the [administration commands that configure the integration daemon](/guides/admin/configuring-an-integration-daemon/).
