...
* [Downloading Egeria to build and run](#cloning-the-egeria-source-using-git-commands) - If you do not want to make changes to Egeria, but want to build the distribution file to run it natively on your machine then follow this task.  If you want to be able to make changes to Egeria and contribute them back to the community, then follow the contributors tasks.
...
* [Adding your contribution to Egeria](#adding-your-contribution-to-an-egeria-git-repository)
