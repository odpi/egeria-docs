...
The admin-services modules has three [Postman :material-github:](/egeria-docs/tools/testing/#postman) collections to illustrate many of the configuration and operation calls:
