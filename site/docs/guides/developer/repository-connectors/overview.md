...
The repository connector's API is provided by the [Open Metadata Repository Services (OMRS)](/egeria-docs/services/omrs).  It defines a call interface to create, search, query, update and delete metadata stored in the metadata repository.
...
You may want to see the [OMRS metamodel](/egeria-docs/guides/developer/metamodel/overview) for more details on the granularity of metadata exchange.
