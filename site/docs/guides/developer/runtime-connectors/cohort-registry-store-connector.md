...
The definition of the connector interface for a [Cohort Registry Store Connnector](/concepts/cohort-registry-store-connector) is
...
An implementation of this connector is located in the
