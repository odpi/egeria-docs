...
The [OMAG server platform](https://egeria-project.org/concepts/omag-server-platform) (aka 'server chassis') is effectively a java process that is launched and acts as a container for
