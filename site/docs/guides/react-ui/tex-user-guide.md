# Type Explorer (tex) User Interface User Guide

The **Repository Explorer (Rex)** can help you explore and visualize the open types in a repository.
It retrieves open types from the repository and displays them.
