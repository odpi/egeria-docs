...
on [Open Metadata Security](/egeria-docs/features/metadata-security/overview/) page.

### Metadata Types

* Updates to the location types in [model 0025](/egeria-docs/types/0/0025-Locations):
...
* Deprecate the **RuntimeForProcess** relationship since it is superfluous - use **ServerAssetUse** since
  **Application** is a **SoftwareServerCapability**.
  See [model 0045](/egeria-docs/types/0/0045-Servers-and-Assets).
...
* Replace the **deployedImplementationType** property with the **businessCapabilityType** in the **BusinessCapability**
  ...
  See [model 0440](/egeria-docs/types/4/0440-Organizational-Controls).
...
More information is available [in the workbench's documentation](/egeria-docs/guides/cts/overview/).
