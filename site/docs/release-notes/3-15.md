...
??? functional "Open Metadata Types"
    ...
    * A new attribute called *waitTime* has been added to the [*NextGovernanceActionType*](/types/4/0462-Governance-Action-Types) entity type to allow delays to be added into a process definition.
