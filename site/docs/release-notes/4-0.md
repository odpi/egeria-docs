...
??? functional "Removal of Analytics Modeling OMAS"
    The deprecated Analytics Modeling OMAS has been removed from the code.  The [Analytic Integrator OMIS](/services/omis/analytics-modeling/overview) now works with the [Data Science OMAS](/services/omas/data-science/overview).
