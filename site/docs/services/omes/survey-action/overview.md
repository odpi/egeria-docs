...
The Survey Action OMES provides support for [survey action engines](/concepts/survey-action-engine) that are part of the [Open Survey Framework (OSF)](/frameworks/osf/overview).
