...
consumed by the [Open Connector Framework (OCF)](/frameworks/ocf/overview), [Open Integration Framework (OIF)](/frameworks/oif/overview), [Open Discovery Framework (ODF)](/frameworks/osf/overview), [Open Governance Framework (OGF)](/frameworks/ogf/overview) and are available through all
