...
- [Egeria-api-actor-manager.http](https://github.com/odpi/egeria/blob/main/open-metadata-implementation/view-server-generic-services/actor-manager/Egeria-api-actor-manager.http)
- [Egeria-jacquard-actors.http](https://github.com/odpi/egeria/blob/main/open-metadata-implementation/view-server-generic-services/actor-manager/Egeria-jacquard-actors.http)
