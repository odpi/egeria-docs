...
The *ActorRole* entity describes a collection of responsibilities that are intended to be performed by an actor. It is a type of [Actor](/types/1/0110-Actors) that adds these new attributes:
