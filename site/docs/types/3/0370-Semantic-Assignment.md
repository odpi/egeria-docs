...
The *SemanticDefinition* relationship links a glossary term to a formal definition of a definition such as a data field used in [data dictionaries](/concepts/data-dictionary) and [data specifications](/concepts/data-specification).
...
!!! info "Similar relationships"
    * The [*MoreInformation*](/types/0/0019-More-Information) relationship is used to show that one element provides more information.  For example, if a glossary term describes a team or a project, the *MoreInformation* relationship could link the term to the [Team](/types/1/0115-Teams) or [Project](/types/1/0130-Projects) element as appropriate.
