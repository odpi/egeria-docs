...
The *DataProcessingDescription* entity captures the details of the processing that is permitted on a data subject's data.  It is type of [collection](/types/0/0021-Collections), allowing finer-grained detail to be nested under newoth it using the *CollectionMembership* relationship.

## PermittedProcessing relationship

The *PermittedProcessing* relationship captures the relationship between a [DataProcessingPurpose](/types/4/0440-Organizational-Controls) and the *DataProcessingDescription* that describes the processing that is permitted on a data subject's data.

## DataProcessingAction entity

The *DataProcessingAction* entity captures an action that is performed on a data subject's data (target).  It is type of [collection](/types/0/0021-Collections), and can have members that are more fine-grained actions.
