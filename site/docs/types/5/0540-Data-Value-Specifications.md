...
![UML](0540-Data-Value-Specifications.svg)
...
* *assignmentStatus* - Defines the provenance and confidence of an assignment of a data definition such as a data class or a data grain to an element.
