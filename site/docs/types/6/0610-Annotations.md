...
The subclasses of Annotation capture specific details of the discovered metadata.
Each annotation is linked to the discovery analysis report it was generated from.
