```mermaid
---
title: DigitalProductManager - Product Manager for Organization List [1c6040fd-abdc-4649-8627-ff5e59ead65a]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Digital Product Manager*
**Product Manager for Organization List**"}
2@{ shape: subproc, label: "*Notification*
**Thu Feb 26 15:33:23 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0005 A regular notification for subscription type Notification type for Weekly refresh subscription for product Organization List (6a57986f-59c8-4458-bbd5-c87bcb2e2cf0) has been triggered.  It will trigger again in 10080 milliseconds**"}
...
**Thu Feb 26 16:06:11 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0001 Welcome to your subscription for product subscription type: Notification type for Weekly refresh subscription for product Organization List (6a57986f-59c8-4458-bbd5-c87bcb2e2cf0)**"}
1==>|"Reviewer [Assignment Scope]"|4
5@{ shape: subproc, label: "*Notification*
**Thu Feb 26 15:33:43 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0001 Welcome to your subscription for product subscription type: Notification type for Ongoing update subscription for product Organization List (ba4f1867-3ce1-4890-8817-af96b4265947)**"}
1==>|"Reviewer [Assignment Scope]"|5
6@{ shape: subproc, label: "*Notification*
**Thu Feb 26 15:33:07 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0004 Your subscription to Notification type for Evaluation subscription for product Organization List (fdbae36a-0697-43c5-acd6-4fad4672edf8) has been triggered**"}
1==>|"Reviewer [Assignment Scope]"|6
7@{ shape: subproc, label: "*Notification*
**Thu Feb 26 15:33:20 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0005 A regular notification for subscription type Notification type for Daily refresh subscription for product Organization List (adacf713-89d7-402d-be67-7af7bdeda658) has been triggered.  It will trigger again in 1440 milliseconds**"}
...
**Notification type for Evaluation subscription for product Organization List**"}
10==>|"product manager notifications [Notification Subscriber]"|1
11@{ shape: doc, label: "*Notification Type*
**Notification type for Daily refresh subscription for product Organization List**"}
11==>|"product manager notifications [Notification Subscriber]"|1
12@{ shape: doc, label: "*Notification Type*
**Notification type for Weekly refresh subscription for product Organization List**"}
