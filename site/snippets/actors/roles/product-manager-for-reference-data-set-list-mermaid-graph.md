```mermaid
---
title: DigitalProductManager - Product Manager for Reference Data Set List [622fca88-a991-4d0e-8c9a-e755f83f7929]
---
flowchart TD
...
**Thu Feb 26 16:16:18 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0003 The monitored ReferenceCodeTable resource Data set for Reference Data Set List (8a2d698c-6a6f-4a2d-9568-5fc9e286c8e0) has changed for subscription type: Notification type for Ongoing update subscription for product Reference Data Set List (d6c08bb1-43b2-478f-a832-8292060ca1b5)**"}
1==>|"Reviewer [Assignment Scope]"|2
3@{ shape: subproc, label: "*Notification*
**Thu Feb 26 16:06:09 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0001 Welcome to your subscription for product subscription type: Notification type for Weekly refresh subscription for product Reference Data Set List (336b39e1-7e08-47fc-b678-1334d5db9948)**"}
1==>|"Reviewer [Assignment Scope]"|3
4@{ shape: subproc, label: "*Notification*
**Thu Feb 26 15:33:22 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0005 A regular notification for subscription type Notification type for Weekly refresh subscription for product Reference Data Set List (336b39e1-7e08-47fc-b678-1334d5db9948) has been triggered.  It will trigger again in 10080 milliseconds**"}
1==>|"Reviewer [Assignment Scope]"|4
5@{ shape: subproc, label: "*Notification*
**Thu Feb 26 16:07:16 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0001 Welcome to your subscription for product subscription type: Notification type for Daily refresh subscription for product Reference Data Set List (d2fe167c-32b8-43cb-b5be-77e0d46102a4)**"}
1==>|"Reviewer [Assignment Scope]"|5
6@{ shape: subproc, label: "*Notification*
**Thu Feb 26 15:34:45 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0005 A regular notification for subscription type Notification type for Daily refresh subscription for product Reference Data Set List (d2fe167c-32b8-43cb-b5be-77e0d46102a4) has been triggered.  It will trigger again in 1440 milliseconds**"}
...
**Notification type for Weekly refresh subscription for product Reference Data Set List**"}
9==>|"product manager notifications [Notification Subscriber]"|1
10@{ shape: doc, label: "*Notification Type*
**Notification type for Daily refresh subscription for product Reference Data Set List**"}
10==>|"product manager notifications [Notification Subscriber]"|1
11@{ shape: doc, label: "*Notification Type*
**Notification type for Evaluation subscription for product Reference Data Set List**"}
