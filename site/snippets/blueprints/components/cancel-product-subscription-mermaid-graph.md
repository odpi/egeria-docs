```mermaid
---
title: SolutionComponent - Cancel Product Subscription [c9ce1de7-d138-4304-aca3-6890280385b0]
---
flowchart TD
...
1==>|"remove subscription [Solution Linking Wire]"|6
7@{ shape: rect, label: "*Solution Component*
**Digital Product Delivery Location**"}
1==>|"(maybe) remove copy [Solution Linking Wire]"|7
