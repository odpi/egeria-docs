```mermaid
---
title: SolutionComponent - Configure Apache Atlas Server Cataloguer [d5eba93e-06d7-4f08-a082-5aeaa6c70b2b]
---
flowchart TD
...
```
> Configure Apache Atlas Server Cataloguer: Link the Apache Atlas server asset to the Apache Atlas Server cataloguer. (Extracted from 6.0-SNAPSHOT)
