```mermaid
---
title: SolutionComponent - Configure the File Folder Cataloguer [553a6cd6-282c-4358-9c5a-4ac4c2d10b99]
---
flowchart TD
...
**catalog-file-folder (FileGovernance)**"}
1==>|"Implemented By"|5
...
```
> Configure the File Folder Cataloguer: Link the File Folder asset to the File Folder cataloguer. (Extracted from 6.0-SNAPSHOT)
