```mermaid
---
title: SolutionComponent - Configure the OMAG Server Platform Cataloguer [ce653660-36bd-4f44-a9c3-b94075f41813]
---
flowchart TD
...
```
> Configure the OMAG Server Platform Cataloguer: Link the OMAG Server Platform asset to the OMAG Server Platform cataloguer. (Extracted from 6.0-SNAPSHOT)
