```mermaid
---
title: SolutionComponent - Copy File [a709e480-ad2e-479e-84fb-dbfb6b2a62dd]
---
flowchart TD
...
```
> Copy File: Copy a file from one directory to another and maintain the open metadata elements describing the files and the lineage representing the data flow between them. (Extracted from 6.0-SNAPSHOT)
