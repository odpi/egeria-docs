```mermaid
---
title: SolutionComponent - Create and catalog Governance Action Process for Unity Catalog Server [faa21bb2-551d-481e-967c-9b616dfcd2b2]
---
flowchart TD
...
```
> Create and catalog Governance Action Process for Unity Catalog Server: Create a Unity Catalog Server and configure an integration connector to catalog its contents. (Extracted from 6.0-SNAPSHOT)
