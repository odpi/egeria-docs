```mermaid
---
title: SolutionComponent - Create and Survey Governance Action Process for Apache Kafka Server [cd5126f3-546a-438f-95d2-3825128bfe19]
---
flowchart TD
...
```
> Create and Survey Governance Action Process for Apache Kafka Server: Create a Apache Kafka Server, run a survey against it, and print out the resulting report. (Extracted from 6.0-SNAPSHOT)
