```mermaid
---
title: SolutionComponent - Create and Survey Governance Action Process for Databricks Unity Catalog Server [b00aaac0-f9ce-438b-a45d-2d283241363c]
---
flowchart TD
...
```
> Create and Survey Governance Action Process for Databricks Unity Catalog Server: Create a Databricks Unity Catalog Server, run a survey against it, and print out the resulting report. (Extracted from 6.0-SNAPSHOT)
