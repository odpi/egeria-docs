```mermaid
---
title: SolutionComponent - Create and Survey Governance Action Process for PostgreSQL Relational Database [b996898b-04c9-418a-85bd-2d1997fcc11c]
---
flowchart TD
...
```
> Create and Survey Governance Action Process for PostgreSQL Relational Database: Create a PostgreSQL Relational Database, run a survey against it, and print out the resulting report. (Extracted from 6.0-SNAPSHOT)
