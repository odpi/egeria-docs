```mermaid
---
title: SolutionComponent - Create Apache Kafka Server in Open Metadata [36fa75fa-dd6e-4120-a6f4-2c1abf4e565d]
---
flowchart TD
...
```
> Create Apache Kafka Server in Open Metadata: Create an asset that represents the server. (Extracted from 6.0-SNAPSHOT)
