```mermaid
---
title: SolutionComponent - Create Data Folder in Open Metadata [f1729715-1e31-471c-93d1-fc9b406a6cec]
---
flowchart TD
...
**create-data-folder (FileGovernance)**"}
1==>|"Implemented By"|6
...
```
> Create Data Folder in Open Metadata: Create a DataFolder asset in open metadata to represent a file system directory.  This is typically used to request a survey or the cataloguing of the files/nested directories within the directory. (Extracted from 6.0-SNAPSHOT)
