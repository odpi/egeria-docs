```mermaid
---
title: SolutionComponent - Create Apache Kafka Topic in Open Metadata [65ef6295-6ddf-4c88-9764-eff5a84f402b]
---
flowchart TD
...
**create-kafka-topic (AssetOnboarding)**"}
1==>|"Implemented By"|5
...
```
> Create Apache Kafka Topic in Open Metadata: Create a KafkaTopic asset in open metadata. (Extracted from 6.0-SNAPSHOT)
