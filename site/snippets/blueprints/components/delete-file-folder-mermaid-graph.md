```mermaid
---
title: SolutionComponent - Delete File Folder from Open Metadata [a822725e-e721-4f78-88a0-115b48d9b787]
---
flowchart TD
...
**delete-file-folder (FileGovernance)**"}
1==>|"Implemented By"|5
...
```
> Delete File Folder from Open Metadata: Delete the requested FileFolder asset using the template placeholder properties used to create it. (Extracted from 6.0-SNAPSHOT)
