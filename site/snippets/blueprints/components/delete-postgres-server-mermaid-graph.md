```mermaid
---
title: SolutionComponent - Delete PostgreSQL Server from Open Metadata [e84da60e-cf37-4506-8594-aac93826185a]
---
flowchart TD
...
**delete-postgres-server (PostgreSQLGovernance)**"}
1==>|"Implemented By"|5
...
```
> Delete PostgreSQL Server from Open Metadata: Delete asset from the metadata repository. (Extracted from 6.0-SNAPSHOT)
