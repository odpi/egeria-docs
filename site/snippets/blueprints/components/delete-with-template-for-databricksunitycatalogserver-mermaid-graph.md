```mermaid
---
title: SolutionComponent - Delete with Template Governance Action Process for Databricks Unity Catalog Server [3591ac70-ec4e-4f1d-ad28-22547ffb06ff]
---
flowchart TD
...
**Open Metadata User**"}
3==>|"delete Databricks Unity Catalog Server [Solution Component Actor]"|1
