```mermaid
---
title: SolutionComponent - Delete with Template Governance Action Process for Data Folder [d1634b19-415b-4749-a19b-0f96fde79af4]
---
flowchart TD
...
**Open Metadata User**"}
3==>|"delete Data Folder [Solution Component Actor]"|1
