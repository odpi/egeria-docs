...
```
> Harvest Open Metadata: Create a collection of database tables full of insight gleaned from the open metadata ecosystem.  This information may be used to analyse the health of the open metadata ecosystem, or to distribute key information to other systems. (Extracted from 6.0-SNAPSHOT)
