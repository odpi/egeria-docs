```mermaid
---
title: Solution Component - Pyegeria-Web [abbb8ef3-2e23-4e8d-ac72-77e4709cc212]
---
flowchart TD
...
```
> Pyegeria-Web: REST-ful service for calling Dr.Egeria from local tools. (Extracted from 6.0-SNAPSHOT)
