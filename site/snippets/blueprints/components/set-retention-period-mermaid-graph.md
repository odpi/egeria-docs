```mermaid
---
title: SolutionComponent - Set Retention Period [edd1702a-c7b5-47ab-8cd2-3750849fe238]
---
flowchart TD
...
```
> Set Retention Period: Set up the retention period for the supplied asset. (Extracted from 6.0-SNAPSHOT)
