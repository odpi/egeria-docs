```mermaid
---
title: SolutionComponent - Survey a PostgreSQL Server [88346a5c-c376-431c-9833-e90f81113cb5]
---
flowchart TD
...
6@{ shape: rect, label: "*Report Type*
**Survey report produced by survey-postgres-server (PostgreSQLSurvey)**"}
1==>|"creates report [Solution Linking Wire]"|6
...
style 6 color:#000000, fill:#DEB887, stroke:#000000
...
```
> Survey a PostgreSQL Server: Create a survey report of the databases found in a requested PostgreSQL Server. (Extracted from 6.0-SNAPSHOT)
