```mermaid
---
title: SolutionComponent - Survey Unity Catalog Volume [608c4836-c88a-4d4c-a774-2d5c37ac7cae]
---
flowchart TD
...
```
> Survey Unity Catalog Volume: Connects to a Unity Catalog Server and creates a survey report that summarizes the data files found in a requested catalog/schema/volume. (Extracted from 6.0-SNAPSHOT)
