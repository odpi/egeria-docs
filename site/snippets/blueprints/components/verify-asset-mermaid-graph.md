```mermaid
---
title: SolutionComponent - Verify Asset [3f76aeab-bb47-4b5b-b77e-803cc73e7e13]
---
flowchart TD
...
```
> Verify Asset: Verify that an asset has the correct classifications set up - which includes zone membership, retention and origin. (Extracted from 6.0-SNAPSHOT)
