```mermaid
---
title: SolutionBlueprint - Jacquard Harvester Content Pack [ea509f7a-de1f-4864-bbbd-6f373f49e132]
---
flowchart TD
...
14==>|"works with [Solution Linking Wire]"|4
...
25==>|"metadata [Solution Linking Wire]"|3
26@{ shape: stadium, label: "*Solution Linking Wire*
**... plus 87 Items**"}
26-.->3
27@{ shape: stadium, label: "*Collection Membership*
**... plus 1 Items**"}
1-.->27
...
click 22 "https://egeria-project.org/concepts/integration-connector/" "Click for more documentation" _blank
...
click 18 "https://egeria-project.org/concepts/open-metadata-repository/" "Click for more documentation" _blank
click 19 "https://egeria-project.org/concepts/open-metadata-archive/" "Click for more documentation" _blank
