```mermaid
---
title: ReportType - Survey report produced by survey-all-folders (FileSurvey) [13f89a88-108a-49c8-88ae-4586aa8fc43d]
---
flowchart TD
...
```
> Survey report produced by survey-all-folders (FileSurvey): Connector supports the surveying of files in a directory (folder) and the directories beneath it. (Extracted from 6.0-SNAPSHOT)
