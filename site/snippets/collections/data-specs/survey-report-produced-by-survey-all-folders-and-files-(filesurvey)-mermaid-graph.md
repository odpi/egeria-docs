```mermaid
---
title: ReportType - Survey report produced by survey-all-folders-and-files (FileSurvey) [4c0b8d0c-60bb-4fa0-9506-da447f7b681c]
---
flowchart TD
...
```
> Survey report produced by survey-all-folders-and-files (FileSurvey): Connector supports the surveying of files in a directory (folder) and the directories beneath it. (Extracted from 6.0-SNAPSHOT)
