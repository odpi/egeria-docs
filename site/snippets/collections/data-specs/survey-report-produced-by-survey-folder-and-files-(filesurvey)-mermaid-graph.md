```mermaid
---
title: ReportType - Survey report produced by survey-folder-and-files (FileSurvey) [69230ba2-30a3-41df-a632-bd8f41396c1d]
---
flowchart TD
...
```
> Survey report produced by survey-folder-and-files (FileSurvey): Connector supports the surveying of files in a directory (folder) and the directories beneath it. (Extracted from 6.0-SNAPSHOT)
