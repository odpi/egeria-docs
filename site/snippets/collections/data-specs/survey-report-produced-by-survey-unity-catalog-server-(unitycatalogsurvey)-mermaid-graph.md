```mermaid
---
title: ReportType - Survey report produced by survey-unity-catalog-server (UnityCatalogSurvey) [d1e153e1-430b-4dc7-9465-3e5f4b272458]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Report Type*
**Survey report produced by survey-unity-catalog-server (UnityCatalogSurvey)**"}
...
```
> Survey report produced by survey-unity-catalog-server (UnityCatalogSurvey): Surveys the catalogs found in a Unity Catalog Server. (Extracted from 6.0-SNAPSHOT)
