```mermaid
---
title: DigitalProduct - basisIdentifier Valid Values [69efdde3-cc82-4443-90cf-0a8ea1e9b699]
---
flowchart TD
...
```
> basisIdentifier Valid Values: Defines the retention requirements associated with a data item. (Extracted from 6.0-SNAPSHOT)
