```mermaid
---
title: DigitalProduct - activityStatus Valid Values [1268c88f-5896-454e-b35f-b0b2c118f064]
---
flowchart TD
...
```
> activityStatus Valid Values: Defines the current execution status of a process. (Extracted from 6.0-SNAPSHOT)
