```mermaid
---
title: DigitalProduct - analysisStep Valid Values [a453ac1e-9551-459d-9520-33eaee1e0c67]
---
flowchart TD
...
```
> analysisStep Valid Values: The step in the analysis that produced the annotation. (Extracted from 6.0-SNAPSHOT)
