```mermaid
---
title: DigitalProduct - annotationStatus Valid Values [d0ee6f44-20f0-48dd-a741-e2d954b006dd]
---
flowchart TD
...
```
> annotationStatus Valid Values: Status of the processing as a result of the annotation. (Extracted from 6.0-SNAPSHOT)
