```mermaid
---
title: DigitalProduct - annotationType Valid Values [87704e30-c6fd-486f-9dec-c133b17af262]
---
flowchart TD
...
```
> annotationType Valid Values: Name of the type of annotation. (Extracted from 6.0-SNAPSHOT)
