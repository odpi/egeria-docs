```mermaid
---
title: DigitalProduct - assignmentStatus Valid Values [9b8f1b61-fdcc-4893-92c8-0ff6a75f24a2]
---
flowchart TD
...
```
> assignmentStatus Valid Values: Defines the provenance and confidence of an assignment of a data definition such as a data class or a data grain to an element. (Extracted from 6.0-SNAPSHOT)
