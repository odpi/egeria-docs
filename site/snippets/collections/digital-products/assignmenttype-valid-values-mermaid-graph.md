```mermaid
---
title: DigitalProduct - assignmentType Valid Values [61792cc3-2c28-4479-a7af-29df69ac88e8]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: assignmentType**"}
...
```
> assignmentType Valid Values: What is the scope or nature of the assignment. (Extracted from 6.0-SNAPSHOT)
