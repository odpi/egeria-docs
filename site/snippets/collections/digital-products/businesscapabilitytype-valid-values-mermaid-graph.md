```mermaid
---
title: DigitalProduct - businessCapabilityType Valid Values [2e88bba4-21ee-4514-8312-4a234e742f30]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: businessCapabilityType**"}
...
```
> businessCapabilityType Valid Values: Defines the type or category of a business capability. (Extracted from 6.0-SNAPSHOT)
