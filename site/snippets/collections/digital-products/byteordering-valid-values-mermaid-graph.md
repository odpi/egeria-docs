```mermaid
---
title: DigitalProduct - byteOrdering Valid Values [50412b93-ddc4-489c-a119-be0841327447]
---
flowchart TD
...
```
> byteOrdering Valid Values: Defines the sequential order in which bytes are arranged into larger numerical values when stored in memory or when transmitted over digital links. (Extracted from 6.0-SNAPSHOT)
