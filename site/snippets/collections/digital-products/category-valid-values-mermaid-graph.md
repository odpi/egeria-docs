```mermaid
---
title: DigitalProduct - category Valid Values [ab6ad8a0-df30-4349-90e8-1c0e85adb8c1]
---
flowchart TD
...
```
> category Valid Values: Descriptive name of the concept that this element applies to. (Extracted from 6.0-SNAPSHOT)
