```mermaid
---
title: DigitalProduct - commentType Valid Values [da3ea919-bf00-44b2-b231-a7f236c51951]
---
flowchart TD
...
```
> commentType Valid Values: Defines the sequential order in which bytes are arranged into larger numerical values when stored in memory or when transmitted over digital links. (Extracted from 6.0-SNAPSHOT)
