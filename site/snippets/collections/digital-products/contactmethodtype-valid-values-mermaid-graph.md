```mermaid
---
title: DigitalProduct - contactMethodType Valid Values [13b7b35f-7e70-4886-86f4-066660f1ae8d]
---
flowchart TD
...
```
> contactMethodType Valid Values: Type of mechanism to contact an actor. (Extracted from 6.0-SNAPSHOT)
