```mermaid
---
title: DigitalProduct - containmentType Valid Values [b6f65a79-1149-48e5-b590-65b6b848fd4a]
---
flowchart TD
...
```
> containmentType Valid Values: The containment relationship between two processes: the parent and one of its children. (Extracted from 6.0-SNAPSHOT)
