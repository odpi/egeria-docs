```mermaid
---
title: DigitalProduct - contentStatus Valid Values [83f4b05b-07a7-43e7-9b12-002aee2bad8e]
---
flowchart TD
...
```
> contentStatus Valid Values: Defines the current status of an authored referenceable. (Extracted from 6.0-SNAPSHOT)
