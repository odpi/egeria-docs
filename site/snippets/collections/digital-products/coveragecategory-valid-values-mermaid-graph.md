```mermaid
---
title: DigitalProduct - coverageCategory Valid Values [7180208f-4c62-4d4e-adcb-86cb6aafd456]
---
flowchart TD
...
```
> coverageCategory Valid Values: Used to describe how a collection of data values for an attribute covers the domain of the possible values to the linked attribute. (Extracted from 6.0-SNAPSHOT)
