```mermaid
---
title: DigitalProduct - decoration Valid Values [fe7eee8a-2eda-4235-b2fb-d24d6f1a5bef]
---
flowchart TD
...
```
> decoration Valid Values: Usage and lifecycle for this connection between the concept bead and the link. (Extracted from 6.0-SNAPSHOT)
