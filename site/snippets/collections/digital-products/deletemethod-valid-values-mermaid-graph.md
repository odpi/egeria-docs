```mermaid
---
title: DigitalProduct - deleteMethod Valid Values [8a0bfec9-96b5-48df-a42d-1fb0b1522cc8]
---
flowchart TD
...
```
> deleteMethod Valid Values: Identifies which type of delete to use. (Extracted from 6.0-SNAPSHOT)
