```mermaid
---
title: DigitalProduct - deployedImplementationType Valid Values [cfc0db78-58cd-4364-8942-36c2c7c8a4ca]
---
flowchart TD
...
```
> deployedImplementationType Valid Values: Name of a particular type of technology.  It is more specific than the open metadata types and increases the precision in which technology is catalogued.  This helps human understanding and enables connectors and other actions to be targeted to the right technology. (Extracted from 6.0-SNAPSHOT)
