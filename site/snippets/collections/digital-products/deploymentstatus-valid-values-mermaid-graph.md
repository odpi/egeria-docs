```mermaid
---
title: DigitalProduct - deploymentStatus Valid Values [779f44c5-3cfe-438f-a541-1c110adbad59]
---
flowchart TD
...
```
> deploymentStatus Valid Values: Defines the current status of an infrastructure element. (Extracted from 6.0-SNAPSHOT)
