```mermaid
---
title: DigitalProduct - direction Valid Values [8ff94ce3-60a1-4eb9-a285-88dea7067805]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: direction**"}
...
```
> direction Valid Values: Which way is data flowing? (Extracted from 6.0-SNAPSHOT)
