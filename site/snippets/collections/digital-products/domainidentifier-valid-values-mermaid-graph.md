```mermaid
---
title: DigitalProduct - domainIdentifier Valid Values [7bfed531-5660-4241-8ab4-477bc54e5dca]
---
flowchart TD
...
```
> domainIdentifier Valid Values: Identifier of the governance domain that recognizes this process. Zero typically means ''any'' domain. (Extracted from 6.0-SNAPSHOT)
