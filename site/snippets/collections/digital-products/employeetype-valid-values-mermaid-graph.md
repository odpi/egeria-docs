```mermaid
---
title: DigitalProduct - employeeType Valid Values [1743c077-daba-476c-9985-ad276f5b804d]
---
flowchart TD
...
```
> employeeType Valid Values: Code used by employer typically to describe the type of employment contract. (Extracted from 6.0-SNAPSHOT)
