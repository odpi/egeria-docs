```mermaid
---
title: DigitalProduct - fileExtension Valid Values [80ed77b9-e949-4a6c-9d33-9dd4b657a564]
---
flowchart TD
...
```
> fileExtension Valid Values: The file extension used at the end of the file''s name.  This identifies the format of the file. (Extracted from 6.0-SNAPSHOT)
