```mermaid
---
title: DigitalProduct - fileName Valid Values [f12a08e8-5b68-4faa-9867-476fe5710f84]
---
flowchart TD
...
```
> fileName Valid Values: The name of the file with extension. (Extracted from 6.0-SNAPSHOT)
