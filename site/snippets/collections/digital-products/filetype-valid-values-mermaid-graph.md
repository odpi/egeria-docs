```mermaid
---
title: DigitalProduct - fileType Valid Values [60803b95-8b92-4bfa-b851-cf7a32f8793d]
---
flowchart TD
...
```
> fileType Valid Values: File type descriptor (or logical file type) typically extracted from the file name. (Extracted from 6.0-SNAPSHOT)
