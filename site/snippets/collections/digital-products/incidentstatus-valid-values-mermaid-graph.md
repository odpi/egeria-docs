```mermaid
---
title: DigitalProduct - incidentStatus Valid Values [bfbd8561-7f7d-47dd-97c4-25ca22827553]
---
flowchart TD
...
```
> incidentStatus Valid Values: Defines the status of an incident report. (Extracted from 6.0-SNAPSHOT)
