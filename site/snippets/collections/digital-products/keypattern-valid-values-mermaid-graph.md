```mermaid
---
title: DigitalProduct - keyPattern Valid Values [e9b22016-f302-4528-9b3c-cb026ed88115]
---
flowchart TD
...
```
> keyPattern Valid Values: Type of identifier that identifies its lifecycle, for example, its scope and whether the value is reused. (Extracted from 6.0-SNAPSHOT)
