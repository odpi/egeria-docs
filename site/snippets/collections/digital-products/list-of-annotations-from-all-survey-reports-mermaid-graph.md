```mermaid
---
title: DigitalProduct - List of Annotations from all Survey Reports [f8cd81d9-7926-4b7b-8b53-280779c56723]
---
flowchart TD
...
```
> List of Annotations from all Survey Reports: A tabular data set where each record describes an annotation from a survey report. (Extracted from 6.0-SNAPSHOT)
