```mermaid
---
title: DigitalProduct - List of Survey Reports [698deea7-5826-4d05-bcc2-68407bc73325]
---
flowchart TD
...
```
> List of Survey Reports: A tabular data set where each record describes a survey report.  These surveys may be run as engine actions in the Engine Host, or run in an external surveying process that published results through the Data Discovery API. (Extracted from 6.0-SNAPSHOT)
