```mermaid
---
title: DigitalProduct - membershipStatus Valid Values [4cd97643-3179-41e7-bddc-a282a713dea5]
---
flowchart TD
...
```
> membershipStatus Valid Values: Defines the provenance and confidence that a member belongs in a collection. (Extracted from 6.0-SNAPSHOT)
