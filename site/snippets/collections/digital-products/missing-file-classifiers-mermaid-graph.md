```mermaid
---
title: DigitalProduct - Missing File Classifiers [8e66364f-fbda-495b-a7a8-57c0543b2b47]
---
flowchart TD
...
```
> Missing File Classifiers: List of files that could not be classified using the file reference data supplied by Core Content Pack. (Extracted from 6.0-SNAPSHOT)
