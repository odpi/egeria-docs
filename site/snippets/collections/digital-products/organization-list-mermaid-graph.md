```mermaid
---
title: DigitalProduct - Organization List [07bb535d-744c-4c86-9047-cc9c36799c5a]
---
flowchart TD
...
```
> Organization List: A tabular data set where each record describes an organization interacting with open metadata. (Extracted from 6.0-SNAPSHOT)
