```mermaid
---
title: DigitalProduct - People List [5bd382aa-95f6-4a5d-a9eb-8bb0ff84b08b]
---
flowchart TD
...
```
> People List: A tabular data set where each record describes a person interacting with open metadata. (Extracted from 6.0-SNAPSHOT)
