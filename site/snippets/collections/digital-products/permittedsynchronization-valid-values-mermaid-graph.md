```mermaid
---
title: DigitalProduct - permittedSynchronization Valid Values [7189b5c7-f6e4-454a-8928-04ae9316d75f]
---
flowchart TD
...
```
> permittedSynchronization Valid Values: Defines the permitted directions of flow of metadata updates between open metadata and a third party technology. (Extracted from 6.0-SNAPSHOT)
