```mermaid
---
title: DigitalProduct - portType Valid Values [471f494f-6c38-4873-b5a5-dfbab1e8966d]
---
flowchart TD
...
```
> portType Valid Values: Descriptor for a port that indicates the direction that data is flowing. (Extracted from 6.0-SNAPSHOT)
