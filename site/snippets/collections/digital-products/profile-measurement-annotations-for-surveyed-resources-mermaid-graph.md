```mermaid
---
title: DigitalProduct - Profile measurement annotations for surveyed resources [1224253b-2e9f-4563-8329-e59e6d489f24]
---
flowchart TD
...
**Data set for Profile measurement annotations for surveyed resources**"}
...
```
> Profile measurement annotations for surveyed resources: Details of individual profile measurements.  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
