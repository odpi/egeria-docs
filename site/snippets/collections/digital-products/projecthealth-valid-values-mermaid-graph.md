```mermaid
---
title: DigitalProduct - projectHealth Valid Values [8cd948b0-0a9a-4861-a19f-fcffa97abd70]
---
flowchart TD
...
```
> projectHealth Valid Values: Indicator on how well the project is tracking to plan. (Extracted from 6.0-SNAPSHOT)
