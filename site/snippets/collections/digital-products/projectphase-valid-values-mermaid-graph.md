```mermaid
---
title: DigitalProduct - projectPhase Valid Values [85e6f063-9df3-4545-bb53-cfc9025ed504]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: projectPhase**"}
...
```
> projectPhase Valid Values: The phase in the lifecycle of the project. (Extracted from 6.0-SNAPSHOT)
