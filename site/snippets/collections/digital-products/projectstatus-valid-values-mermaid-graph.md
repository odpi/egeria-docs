```mermaid
---
title: DigitalProduct - projectStatus Valid Values [b27aee1a-9c9f-4196-88ad-78637e22d8c2]
---
flowchart TD
...
```
> projectStatus Valid Values: Short description on current status of the project. (Extracted from 6.0-SNAPSHOT)
