```mermaid
---
title: DigitalProduct - Resource measurement annotations for surveyed directories (folders) [cd4bcfee-c6f4-464b-965c-a12c9a3d90fc]
---
flowchart TD
...
```
> Resource measurement annotations for surveyed directories (folders): Details of files found in a directory (and subdirectories).  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
