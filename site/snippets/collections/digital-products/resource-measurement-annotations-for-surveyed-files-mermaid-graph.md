```mermaid
---
title: DigitalProduct - Resource measurement annotations for surveyed Files [2ef3dcea-f470-4271-aecc-f155c30ce463]
---
flowchart TD
...
```
> Resource measurement annotations for surveyed Files: Details of the measurements collected by a survey of files from multiple directories (folders).  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
