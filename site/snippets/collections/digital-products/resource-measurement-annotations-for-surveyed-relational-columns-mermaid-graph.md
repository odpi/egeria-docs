```mermaid
---
title: DigitalProduct - Resource measurement annotations for surveyed Relational Columns [6ded357e-cb85-44fc-9b19-f6c278d20a71]
---
flowchart TD
...
```
> Resource measurement annotations for surveyed Relational Columns: Details of the measurements collected by a survey of relational columns from multiple databases.  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
