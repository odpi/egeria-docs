```mermaid
---
title: DigitalProduct - Resource measurement annotations for surveyed Relational Data Managers [6ec72897-4930-4273-a25a-f8004cbb80d6]
---
flowchart TD
...
```
> Resource measurement annotations for surveyed Relational Data Managers: Details of the measurements collected by a survey of a relational data manager.  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
