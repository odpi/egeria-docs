```mermaid
---
title: DigitalProduct - Resource measurement annotations for surveyed Relational Tables [c2b29ab9-6a9d-4361-b6bd-f1fdc8bd017b]
---
flowchart TD
...
**Create Daily refresh subscription for Relational Table Measurements**"}
1==>|"Create Subscription [Resource List]"|2
3@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Relational Table Measurements**"}
1==>|"Create Subscription [Resource List]"|3
4@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Relational Table Measurements**"}
1==>|"Create Subscription [Resource List]"|4
5@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Relational Table Measurements**"}
...
**Product Manager for Relational Table Measurements**"}
...
```
> Resource measurement annotations for surveyed Relational Tables: Details of the measurements collected by a survey of relational tables from multiple databases.  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
