```mermaid
---
title: DigitalProduct - Resource measurement annotations for surveyed resources [641b139c-7fff-4c93-9cd6-80f6ac51b0c5]
---
flowchart TD
...
```
> Resource measurement annotations for surveyed resources: Details of individual resources surveyed.  This digital product supplements the main annotation list product (Annotation List). (Extracted from 6.0-SNAPSHOT)
