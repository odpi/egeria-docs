```mermaid
---
title: DigitalProduct - resourceUse Valid Values [5dcc0148-d7bb-4752-a28e-19e819d44b5f]
---
flowchart TD
...
```
> resourceUse Valid Values: Identifier that describes the type of resource use. (Extracted from 6.0-SNAPSHOT)
