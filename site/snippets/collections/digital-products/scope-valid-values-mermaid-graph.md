```mermaid
---
title: DigitalProduct - scope Valid Values [f6e1f4fa-56d8-4df1-bdc8-7ba02ca561b2]
---
flowchart TD
...
```
> scope Valid Values: Breadth of responsibility or coverage. (Extracted from 6.0-SNAPSHOT)
