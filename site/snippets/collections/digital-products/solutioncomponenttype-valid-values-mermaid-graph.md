```mermaid
---
title: DigitalProduct - solutionComponentType Valid Values [484fb480-6020-4a26-b43b-0b34386a4f8f]
---
flowchart TD
...
```
> solutionComponentType Valid Values: The type of solution component - for example, is it a process, of file or database. (Extracted from 6.0-SNAPSHOT)
