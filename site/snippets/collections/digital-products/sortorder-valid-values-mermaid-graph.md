```mermaid
---
title: DigitalProduct - sortOrder Valid Values [22963fd3-a648-4415-8edd-907328010813]
---
flowchart TD
...
```
> sortOrder Valid Values: Defines the suggested order that data values in this data item should be sorted by. (Extracted from 6.0-SNAPSHOT)
