```mermaid
---
title: DigitalProduct - status Valid Values [d6f3760a-069d-4fdc-ba06-dc17c81044eb]
---
flowchart TD
...
```
> status Valid Values: Defines the confidence in the assigned relationship. (Extracted from 6.0-SNAPSHOT)
