```mermaid
---
title: DigitalProduct - statusIdentifier Valid Values [04f487f9-2ec5-4388-89f6-e090f65243cc]
---
flowchart TD
...
```
> statusIdentifier Valid Values: Defines the status values of a governance action classification. (Extracted from 6.0-SNAPSHOT)
