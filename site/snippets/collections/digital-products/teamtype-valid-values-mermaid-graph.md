```mermaid
---
title: DigitalProduct - teamType Valid Values [dacd7359-599e-4809-a7ec-d194a4a4e207]
---
flowchart TD
...
```
> teamType Valid Values: Type of team, such as division, or department. (Extracted from 6.0-SNAPSHOT)
