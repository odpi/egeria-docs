```mermaid
---
title: DigitalProduct - termAssignmentStatus Valid Values [5ef6b638-73d8-40a1-b6de-13671e535728]
---
flowchart TD
...
```
> termAssignmentStatus Valid Values: Defines the provenance and confidence of a term assignment. (Extracted from 6.0-SNAPSHOT)
