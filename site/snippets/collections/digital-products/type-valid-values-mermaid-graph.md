```mermaid
---
title: DigitalProduct - type Valid Values [7692c367-3c14-437a-a84e-7879b4ccf9b2]
---
flowchart TD
...
```
> type Valid Values: Different types of activities. (Extracted from 6.0-SNAPSHOT)
