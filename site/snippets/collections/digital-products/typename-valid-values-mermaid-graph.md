```mermaid
---
title: DigitalProduct - typeName Valid Values [11a92a23-3703-4ec4-bdfc-c02a575a4c94]
---
flowchart TD
...
```
> typeName Valid Values: Name of an open metadata type. (Extracted from 6.0-SNAPSHOT)
