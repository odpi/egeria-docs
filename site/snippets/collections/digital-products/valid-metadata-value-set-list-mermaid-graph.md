```mermaid
---
title: DigitalProduct - Valid Metadata Value Set List [296a28ea-4368-457d-b51a-f3e5899039b3]
---
flowchart TD
...
```
> Valid Metadata Value Set List: A tabular data set where each record describes an open metadata property that has a valid metadata value set defined.  There is a digital product for each open metadata property in this list. (Extracted from 6.0-SNAPSHOT)
