```mermaid
---
title: ReferenceCodeTable - Data set for activityStatus Valid Values [bdb44005-1881-4a98-bcf2-c7e71cf94111]
---
flowchart TD
...
**97d6105d-7a16-48b4-be14-372f14e3d799**"}
...
**Asset Connection for activityStatus Valid Values**"}
...
**Reference data set for activityStatus Valid Values**"}
...
```
> Data set for activityStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
