```mermaid
---
title: ReferenceCodeTable - Data set for additionalProperties Valid Values [c5b849b1-04cf-4216-b55c-1d90c45abada]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for additionalProperties Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**f5fc308e-c951-4ac7-8d55-8a17edb2838c**"}
1==>|"Search Keyword Link"|2
3@{ shape: subproc, label: "*Notification*
**Thu Feb 26 16:16:01 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0003 The monitored ReferenceCodeTable resource Data set for additionalProperties Valid Values (c5b849b1-04cf-4216-b55c-1d90c45abada) has changed for subscription type: Notification type for Ongoing update subscription for product Valid Metadata Value Set: additionalProperties (a6961414-c44c-4c7e-9ed9-aea7b9b4a1af)**"}
...
**Asset Connection for additionalProperties Valid Values**"}
...
**Reference data set for additionalProperties Valid Values**"}
6==>|"Connect To Endpoint"|11
12@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: additionalProperties**"}
...
**Create Weekly refresh subscription for Valid Metadata Value Set: additionalProperties**"}
...
```
> Data set for additionalProperties Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
