```mermaid
---
title: ReferenceCodeTable - Data set for analysisStep Valid Values [0b1435ca-9fd5-47ad-9155-bdf02430ba95]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for analysisStep Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**75d9778c-faec-4400-94cd-c0e4fb93ff9b**"}
...
**Asset Connection for analysisStep Valid Values**"}
...
**Reference data set for analysisStep Valid Values**"}
...
```
> Data set for analysisStep Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
