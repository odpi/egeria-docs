```mermaid
---
title: ReferenceCodeTable - Data set for annotationStatus Valid Values [201661a3-cb8e-442c-a2fc-1d61ec459911]
---
flowchart TD
...
**5ede2d40-54ee-4a3a-bbf5-f3245f4535d3**"}
...
**Asset Connection for annotationStatus Valid Values**"}
...
**Reference data set for annotationStatus Valid Values**"}
...
```
> Data set for annotationStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
