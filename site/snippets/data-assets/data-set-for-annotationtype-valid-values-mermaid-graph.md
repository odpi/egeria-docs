```mermaid
---
title: ReferenceCodeTable - Data set for annotationType Valid Values [7db43f32-e327-4a91-ad04-483855faf2d3]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for annotationType Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**eab9b0f7-5b2c-4576-8d5c-ca10220a7f54**"}
...
**Asset Connection for annotationType Valid Values**"}
...
**Reference data set for annotationType Valid Values**"}
...
```
> Data set for annotationType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
