```mermaid
---
title: ReferenceCodeTable - Data set for assignmentStatus Valid Values [09bdb7a4-fc8c-4156-b316-af7c223c3c94]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for assignmentStatus Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**e80f68eb-8b30-4dd3-a758-80d40b2b150e**"}
1==>|"Search Keyword Link"|2
3@{ shape: rect, label: "*Digital Product*
**assignmentStatus Valid Values**"}
3==>|"product data set [Collection Membership]"|1
4@{ shape: rounded, label: "*Virtual Connection*
**Asset Connection for assignmentStatus Valid Values**"}
...
**Reference data set for assignmentStatus Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: assignmentStatus**"}
10==>|"product asset [Monitored Resource]"|1
11@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: assignmentStatus**"}
...
**Create Ongoing update subscription for Valid Metadata Value Set: assignmentStatus**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: assignmentStatus**"}
...
```
> Data set for assignmentStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
