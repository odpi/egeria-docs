```mermaid
---
title: ReferenceCodeTable - Data set for assignmentType Valid Values [0aacb8ee-7b56-4dbb-a5ee-e1b0e309ed07]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for assignmentType Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**16cd99d9-fa25-4f4b-8ef8-2e92c85eed9a**"}
1==>|"Search Keyword Link"|2
3@{ shape: rect, label: "*Digital Product*
**assignmentType Valid Values**"}
3==>|"product data set [Collection Membership]"|1
4@{ shape: rounded, label: "*Virtual Connection*
**Asset Connection for assignmentType Valid Values**"}
...
**Reference data set for assignmentType Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: assignmentType**"}
10==>|"product asset [Monitored Resource]"|1
11@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: assignmentType**"}
11==>|"sourceDataSet [Target For Governance Action]"|1
12@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: assignmentType**"}
12==>|"sourceDataSet [Target For Governance Action]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Daily refresh subscription for Valid Metadata Value Set: assignmentType**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: assignmentType**"}
...
```
> Data set for assignmentType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
