```mermaid
---
title: ReferenceCodeTable - Data set for businessCapabilityType Valid Values [80e7cb8e-b668-40bd-bc9c-061b8118aa76]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for businessCapabilityType Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**07c045c8-9269-44a8-8a81-c6b881aeca2c**"}
1==>|"Search Keyword Link"|2
3@{ shape: rect, label: "*Digital Product*
**businessCapabilityType Valid Values**"}
3==>|"product data set [Collection Membership]"|1
4@{ shape: rounded, label: "*Virtual Connection*
**Asset Connection for businessCapabilityType Valid Values**"}
...
**Reference data set for businessCapabilityType Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: businessCapabilityType**"}
10==>|"product asset [Monitored Resource]"|1
11@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: businessCapabilityType**"}
11==>|"sourceDataSet [Target For Governance Action]"|1
12@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: businessCapabilityType**"}
12==>|"sourceDataSet [Target For Governance Action]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: businessCapabilityType**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Daily refresh subscription for Valid Metadata Value Set: businessCapabilityType**"}
...
```
> Data set for businessCapabilityType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
