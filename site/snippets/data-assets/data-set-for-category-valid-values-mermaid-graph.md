```mermaid
---
title: ReferenceCodeTable - Data set for category Valid Values [5edde3e6-3abe-4fb6-81e4-77df53eb745c]
---
flowchart TD
...
**6feeb0fc-031a-4680-a9be-92ea98d3ff1e**"}
...
**Asset Connection for category Valid Values**"}
...
**Reference data set for category Valid Values**"}
...
```
> Data set for category Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
