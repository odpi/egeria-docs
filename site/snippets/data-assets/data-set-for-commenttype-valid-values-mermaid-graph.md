...
**Asset Connection for commentType Valid Values**"}
...
**Reference data set for commentType Valid Values**"}
...
```
> Data set for commentType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
