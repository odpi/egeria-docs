```mermaid
---
title: ReferenceCodeTable - Data set for contactMethodType Valid Values [da0a1c32-d076-47f3-87b1-58c184b1b23e]
---
flowchart TD
...
**31312c63-93b9-431d-8958-a6396441922f**"}
...
**Asset Connection for contactMethodType Valid Values**"}
...
**Reference data set for contactMethodType Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: contactMethodType**"}
10==>|"product asset [Monitored Resource]"|1
11@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: contactMethodType**"}
11==>|"sourceDataSet [Target For Governance Action]"|1
12@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: contactMethodType**"}
12==>|"sourceDataSet [Target For Governance Action]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: contactMethodType**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Daily refresh subscription for Valid Metadata Value Set: contactMethodType**"}
...
```
> Data set for contactMethodType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
