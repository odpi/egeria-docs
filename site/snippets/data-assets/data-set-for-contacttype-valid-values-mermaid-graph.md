```mermaid
---
title: ReferenceCodeTable - Data set for contactType Valid Values [21ded9d5-14a6-4191-afbc-bec64d893be4]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for contactType Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**729097c8-0a24-421e-b930-59f1f4aa7846**"}
1==>|"Search Keyword Link"|2
3@{ shape: subproc, label: "*Notification*
**Thu Feb 26 16:16:05 GMT 2026 BAUDOT-SUBSCRIPTION-MANAGEMENT-0003 The monitored ReferenceCodeTable resource Data set for contactType Valid Values (21ded9d5-14a6-4191-afbc-bec64d893be4) has changed for subscription type: Notification type for Ongoing update subscription for product Valid Metadata Value Set: contactType (96e764f7-a3a2-4bc6-98e2-849beefcb078)**"}
...
**Reference data set for contactType Valid Values**"}
6==>|"Connect To Endpoint"|11
12@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: contactType**"}
12==>|"product asset [Monitored Resource]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: contactType**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Daily refresh subscription for Valid Metadata Value Set: contactType**"}
14==>|"sourceDataSet [Target For Governance Action]"|1
15@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: contactType**"}
15==>|"sourceDataSet [Target For Governance Action]"|1
16@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: contactType**"}
...
```
> Data set for contactType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
