```mermaid
---
title: ReferenceCodeTable - Data set for dataClassAssignmentStatus Valid Values [3e1097c6-6a88-4742-8d53-d9081154b389]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for dataClassAssignmentStatus Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**2f209459-10fd-42d3-a48f-02da6e35b2d8**"}
...
**Asset Connection for dataClassAssignmentStatus Valid Values**"}
...
**Reference data set for dataClassAssignmentStatus Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: dataClassAssignmentStatus**"}
10==>|"product asset [Monitored Resource]"|1
11@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: dataClassAssignmentStatus**"}
11==>|"sourceDataSet [Target For Governance Action]"|1
12@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: dataClassAssignmentStatus**"}
12==>|"sourceDataSet [Target For Governance Action]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Daily refresh subscription for Valid Metadata Value Set: dataClassAssignmentStatus**"}
...
```
> Data set for dataClassAssignmentStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
