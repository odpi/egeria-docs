```mermaid
---
title: ReferenceCodeTable - Data set for decoration Valid Values [cdfffcfb-91c3-45da-9594-8c94f963b973]
---
flowchart TD
...
**de78eba0-3c4a-4205-827d-044968314dba**"}
...
**Asset Connection for decoration Valid Values**"}
...
**Reference data set for decoration Valid Values**"}
...
```
> Data set for decoration Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
