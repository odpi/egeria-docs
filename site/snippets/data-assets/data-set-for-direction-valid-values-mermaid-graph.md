```mermaid
---
title: ReferenceCodeTable - Data set for direction Valid Values [e560bcf6-d0d6-404f-afc6-c3c834fb9641]
---
flowchart TD
...
**270a3146-bb0a-48af-8dd2-50c3cfdab1ab**"}
...
**Asset Connection for direction Valid Values**"}
...
```
> Data set for direction Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
