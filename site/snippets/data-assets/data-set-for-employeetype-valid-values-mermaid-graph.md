```mermaid
---
title: ReferenceCodeTable - Data set for employeeType Valid Values [4a7cc916-47ce-4cc8-9f00-9f7e39a530c3]
---
flowchart TD
...
**337db238-2975-4b20-8650-07ee343d4fed**"}
...
**Asset Connection for employeeType Valid Values**"}
...
**Reference data set for employeeType Valid Values**"}
...
```
> Data set for employeeType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
