```mermaid
---
title: ReferenceCodeTable - Data set for facilityType Valid Values [4d16d028-36d2-4bb8-acc7-44c0dd55f930]
---
flowchart TD
...
**262bb782-f291-458e-afcb-7edc39e2ebb8**"}
...
**Asset Connection for facilityType Valid Values**"}
...
**Reference data set for facilityType Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Reference Data Set: facilityType**"}
...
```
> Data set for facilityType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
