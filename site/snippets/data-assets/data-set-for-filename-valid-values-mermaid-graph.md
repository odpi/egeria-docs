```mermaid
---
title: ReferenceCodeTable - Data set for fileName Valid Values [5d3f7479-0416-4c0f-a50a-6f6e1600547e]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for fileName Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**343d948c-2e9c-4d37-a55f-9fe01b659e6d**"}
...
**Asset Connection for fileName Valid Values**"}
...
**Reference data set for fileName Valid Values**"}
...
```
> Data set for fileName Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
