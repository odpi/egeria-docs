...
**Asset Connection for incidentStatus Valid Values**"}
...
**Reference data set for incidentStatus Valid Values**"}
...
```
> Data set for incidentStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
