```mermaid
---
title: ReferenceCodeTable - Data set for levelIdentifier Valid Values [47c8680b-b709-4c10-95bc-df7f21a271d5]
---
flowchart TD
...
**4188bba8-5d27-4320-8861-83e6d53d2fed**"}
...
**Asset Connection for levelIdentifier Valid Values**"}
...
**Reference data set for levelIdentifier Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: levelIdentifier**"}
...
```
> Data set for levelIdentifier Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
