```mermaid
---
title: ReferenceCodeTable - Data set for List of Request For Action Annotations from all Survey Reports [5a59e6d0-b90b-43d0-867e-da6bff0b5cdc]
---
flowchart TD
...
**454ee39e-ac79-4f32-b4eb-5c829de52970**"}
...
**Notification type for Ongoing update subscription for product Request For Action Target List**"}
4==>|"product asset [Monitored Resource]"|1
5@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Request For Action Target List**"}
5==>|"sourceDataSet [Target For Governance Action]"|1
6@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Request For Action Target List**"}
6==>|"sourceDataSet [Target For Governance Action]"|1
7@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Request For Action Target List**"}
...
```
> Data set for List of Request For Action Annotations from all Survey Reports: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
