```mermaid
---
title: ReferenceCodeTable - Data set for membershipStatus Valid Values [2ef703c7-7ba9-4b00-a533-88786aae504b]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for membershipStatus Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**d5404266-899b-4a20-893b-48505530f353**"}
...
**Asset Connection for membershipStatus Valid Values**"}
...
**Reference data set for membershipStatus Valid Values**"}
...
```
> Data set for membershipStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
