...
**Asset Connection for permittedSynchronization Valid Values**"}
...
**Reference data set for permittedSynchronization Valid Values**"}
...
```
> Data set for permittedSynchronization Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
