```mermaid
---
title: ReferenceCodeTable - Data set for portType Valid Values [4b2ccc30-0c5e-4c3f-ab5f-e489aaff12a4]
---
flowchart TD
...
**44cfaa62-c3da-4d1f-a132-ed77716b8e89**"}
...
**Asset Connection for portType Valid Values**"}
...
```
> Data set for portType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
