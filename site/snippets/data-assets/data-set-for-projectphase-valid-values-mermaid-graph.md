```mermaid
---
title: ReferenceCodeTable - Data set for projectPhase Valid Values [347cf355-2603-4e8a-b39e-4f8b6b110a7a]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for projectPhase Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**72651424-030a-4ffc-b19e-871c179cd148**"}
1==>|"Search Keyword Link"|2
3@{ shape: rect, label: "*Digital Product*
**projectPhase Valid Values**"}
3==>|"product data set [Collection Membership]"|1
4@{ shape: rounded, label: "*Virtual Connection*
**Asset Connection for projectPhase Valid Values**"}
...
**Reference data set for projectPhase Valid Values**"}
4==>|"Connect To Endpoint"|9
10@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: projectPhase**"}
10==>|"product asset [Monitored Resource]"|1
11@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: projectPhase**"}
11==>|"sourceDataSet [Target For Governance Action]"|1
12@{ shape: processes, label: "*Governance Action Process*
**Create Daily refresh subscription for Valid Metadata Value Set: projectPhase**"}
12==>|"sourceDataSet [Target For Governance Action]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: projectPhase**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: projectPhase**"}
...
```
> Data set for projectPhase Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
