```mermaid
---
title: ReferenceCodeTable - Data set for projectStatus Valid Values [8347a06e-eda8-4f1c-aa76-6a551e466924]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for projectStatus Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**fd8343ef-fea6-4616-a31e-37a817eaf0ed**"}
1==>|"Search Keyword Link"|2
3@{ shape: rect, label: "*Digital Product*
**projectStatus Valid Values**"}
3==>|"product data set [Collection Membership]"|1
4@{ shape: rounded, label: "*Virtual Connection*
**Asset Connection for projectStatus Valid Values**"}
...
**Reference data set for projectStatus Valid Values**"}
...
```
> Data set for projectStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
