```mermaid
---
title: ReferenceCodeTable - Data set for Resource measurement annotations for surveyed directories (folders) [3a0fd4be-5297-40ad-b672-6e728947a72a]
---
flowchart TD
...
**b3f23013-d07e-4d03-b84b-98903b435f44**"}
...
**Notification type for Ongoing update subscription for product File Directory (Folder) Measurements**"}
4==>|"product asset [Monitored Resource]"|1
5@{ shape: processes, label: "*Governance Action Process*
**Create Ongoing update subscription for File Directory (Folder) Measurements**"}
5==>|"sourceDataSet [Target For Governance Action]"|1
6@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for File Directory (Folder) Measurements**"}
...
```
> Data set for Resource measurement annotations for surveyed directories (folders): This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
