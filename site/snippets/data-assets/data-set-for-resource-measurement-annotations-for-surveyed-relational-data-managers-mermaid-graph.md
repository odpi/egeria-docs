```mermaid
---
title: ReferenceCodeTable - Data set for Resource measurement annotations for surveyed Relational Data Managers [93f2823e-f60e-4155-8d8a-ef53fafbad71]
---
flowchart TD
...
**8a583891-ca77-4e5b-b387-1aa0b6347d96**"}
...
```
> Data set for Resource measurement annotations for surveyed Relational Data Managers: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
