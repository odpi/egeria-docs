```mermaid
---
title: ReferenceCodeTable - Data set for Resource measurement annotations for surveyed Relational Schemas [806f906b-936c-45a1-9a3b-0ddc41233e34]
---
flowchart TD
...
**04784d99-b724-4a30-8fdc-a6fc1836238e**"}
...
```
> Data set for Resource measurement annotations for surveyed Relational Schemas: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
