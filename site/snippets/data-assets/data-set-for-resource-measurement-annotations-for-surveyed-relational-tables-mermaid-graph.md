```mermaid
---
title: ReferenceCodeTable - Data set for Resource measurement annotations for surveyed Relational Tables [855fd712-4577-4e53-9d53-dc3ce7e1998c]
---
flowchart TD
...
**e51b2fcf-2e86-45a0-a393-95b3212766f9**"}
...
**Notification type for Ongoing update subscription for product Relational Table Measurements**"}
...
```
> Data set for Resource measurement annotations for surveyed Relational Tables: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
