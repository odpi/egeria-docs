```mermaid
---
title: ReferenceCodeTable - Data set for Resource measurement annotations for surveyed resources [0940cde9-e287-42c3-b232-39f7fa455240]
---
flowchart TD
...
**8f309950-6f18-4ebc-8293-563b15b76548**"}
...
```
> Data set for Resource measurement annotations for surveyed resources: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
