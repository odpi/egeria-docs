```mermaid
---
title: ReferenceCodeTable - Data set for resourceUse Valid Values [95306192-1deb-49d7-b26f-f3827a023f3c]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for resourceUse Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**71940004-8f63-421f-bbfd-56c51b2dc2cf**"}
...
**Asset Connection for resourceUse Valid Values**"}
...
**Reference data set for resourceUse Valid Values**"}
...
```
> Data set for resourceUse Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
