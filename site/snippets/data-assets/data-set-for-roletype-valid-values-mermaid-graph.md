```mermaid
---
title: ReferenceCodeTable - Data set for roleType Valid Values [db54fe18-ef39-4c1b-a474-21e4e4764aba]
---
flowchart TD
...
**f53755f8-f8ef-458d-8d50-0c44c950e23e**"}
...
**Asset Connection for roleType Valid Values**"}
...
**Reference data set for roleType Valid Values**"}
...
```
> Data set for roleType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
