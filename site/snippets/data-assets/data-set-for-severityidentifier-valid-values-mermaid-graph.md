...
**Asset Connection for severityIdentifier Valid Values**"}
...
**Reference data set for severityIdentifier Valid Values**"}
...
```
> Data set for severityIdentifier Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
