```mermaid
---
title: ReferenceCodeTable - Data set for solutionComponentType Valid Values [81b60799-45a3-4adc-885f-f03648b09d96]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Reference Code Table*
**Data set for solutionComponentType Valid Values**"}
2@{ shape: delay, label: "*Search Keyword*
**eb33d727-41eb-4b4c-ad7a-ec86e888cbcd**"}
...
**Asset Connection for solutionComponentType Valid Values**"}
...
**Reference data set for solutionComponentType Valid Values**"}
...
```
> Data set for solutionComponentType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
