```mermaid
---
title: ReferenceCodeTable - Data set for sortOrder Valid Values [274a5cff-1693-4980-b91a-f8ada6574e5d]
---
flowchart TD
...
**a9a294f1-5939-4cb7-8cb9-1b452ec320b9**"}
...
**Asset Connection for sortOrder Valid Values**"}
...
**Reference data set for sortOrder Valid Values**"}
...
```
> Data set for sortOrder Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
