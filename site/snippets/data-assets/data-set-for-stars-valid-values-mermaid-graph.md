...
**Asset Connection for stars Valid Values**"}
...
**Reference data set for stars Valid Values**"}
...
```
> Data set for stars Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
