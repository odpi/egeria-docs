```mermaid
---
title: ReferenceCodeTable - Data set for status Valid Values [61d0d336-ff36-436e-a053-1808dccbc788]
---
flowchart TD
...
**38fc53d1-2654-4536-b72e-781ff50f9266**"}
...
**Asset Connection for status Valid Values**"}
...
**Reference data set for status Valid Values**"}
...
```
> Data set for status Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
