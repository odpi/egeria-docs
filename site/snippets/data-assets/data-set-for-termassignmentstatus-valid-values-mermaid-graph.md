```mermaid
---
title: ReferenceCodeTable - Data set for termAssignmentStatus Valid Values [30e96a36-5874-47dc-98e7-e35e499d6b33]
---
flowchart TD
...
**eb18c01b-496f-4627-b568-97744b3bd779**"}
...
**Asset Connection for termAssignmentStatus Valid Values**"}
...
**Reference data set for termAssignmentStatus Valid Values**"}
...
**Create Daily refresh subscription for Valid Metadata Value Set: termAssignmentStatus**"}
12==>|"sourceDataSet [Target For Governance Action]"|1
13@{ shape: processes, label: "*Governance Action Process*
**Create Evaluation subscription for Valid Metadata Value Set: termAssignmentStatus**"}
13==>|"sourceDataSet [Target For Governance Action]"|1
14@{ shape: processes, label: "*Governance Action Process*
**Create Weekly refresh subscription for Valid Metadata Value Set: termAssignmentStatus**"}
...
```
> Data set for termAssignmentStatus Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
