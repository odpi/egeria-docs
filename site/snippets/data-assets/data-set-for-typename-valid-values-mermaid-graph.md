```mermaid
---
title: ReferenceCodeTable - Data set for typeName Valid Values [79c2cfc1-376a-49c7-aa3b-02948313986c]
---
flowchart TD
...
**122e3464-76f3-4c14-8996-39dbaf02265d**"}
...
**Asset Connection for typeName Valid Values**"}
...
**Reference data set for typeName Valid Values**"}
...
```
> Data set for typeName Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
