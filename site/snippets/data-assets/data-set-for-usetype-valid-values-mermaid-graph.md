```mermaid
---
title: ReferenceCodeTable - Data set for useType Valid Values [d6978e80-06db-4a3f-937a-ecd95c4039b4]
---
flowchart TD
...
**f7526fd4-5617-4bde-aeb1-562cdc1b718d**"}
...
**Asset Connection for useType Valid Values**"}
...
**Reference data set for useType Valid Values**"}
...
```
> Data set for useType Valid Values: This asset represents the source of data for the digital product. (Extracted from 6.0-SNAPSHOT)
