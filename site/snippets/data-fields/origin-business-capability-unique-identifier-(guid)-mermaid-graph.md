```mermaid
---
title: DataField - Origin Business Capability Unique Identifier (GUID) [1788ff73-8cb3-4fe9-93bd-69fc0c52e9cd]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Field*
**Origin Business Capability Unique Identifier (GUID)**"}
