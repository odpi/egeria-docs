```mermaid
---
title: DataField - Semantic Assignment Glossary Term Unique Identifier (GUID) [25275cee-4c86-4103-9f3c-9ed5f58a60f4]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Field*
**Semantic Assignment Glossary Term Unique Identifier (GUID)**"}
