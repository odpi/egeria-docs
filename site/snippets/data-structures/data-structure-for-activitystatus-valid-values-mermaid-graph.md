```mermaid
---
title: DataStructure - Data Structure for activityStatus Valid Values [b080816f-ae29-4ea4-a4ea-4056207d1153]
---
flowchart TD
...
**Data Specification for activityStatus Valid Values**"}
...
```
> Data Structure for activityStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: activityStatus product. (Extracted from 6.0-SNAPSHOT)
