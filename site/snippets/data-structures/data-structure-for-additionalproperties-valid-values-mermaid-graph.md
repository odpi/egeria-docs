```mermaid
---
title: DataStructure - Data Structure for additionalProperties Valid Values [7b4d5781-1f7e-4eb6-a011-ceae06b4f1e7]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for additionalProperties Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for additionalProperties Valid Values**"}
...
```
> Data Structure for additionalProperties Valid Values: The data structure lists the fields in the Valid Metadata Value Set: additionalProperties product. (Extracted from 6.0-SNAPSHOT)
