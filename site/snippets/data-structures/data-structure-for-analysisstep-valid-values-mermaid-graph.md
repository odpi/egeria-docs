```mermaid
---
title: DataStructure - Data Structure for analysisStep Valid Values [c78fa3e3-2625-4c24-9721-e591c4a91915]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for analysisStep Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for analysisStep Valid Values**"}
...
```
> Data Structure for analysisStep Valid Values: The data structure lists the fields in the Valid Metadata Value Set: analysisStep product. (Extracted from 6.0-SNAPSHOT)
