```mermaid
---
title: DataStructure - Data Structure for annotationStatus Valid Values [04474c50-d085-47cb-bc3b-e91c4f8ebc47]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for annotationStatus Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for annotationStatus Valid Values**"}
...
```
> Data Structure for annotationStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: annotationStatus product. (Extracted from 6.0-SNAPSHOT)
