```mermaid
---
title: DataStructure - Data Structure for annotationType Valid Values [fee5680b-fd0d-490a-bfaa-396f7e76f6f8]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for annotationType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for annotationType Valid Values**"}
...
```
> Data Structure for annotationType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: annotationType product. (Extracted from 6.0-SNAPSHOT)
