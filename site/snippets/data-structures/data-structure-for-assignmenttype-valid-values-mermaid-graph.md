```mermaid
---
title: DataStructure - Data Structure for assignmentType Valid Values [6ac410bc-82f8-46c2-bc8d-b3944f3ee52d]
---
flowchart TD
...
```
> Data Structure for assignmentType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: assignmentType product. (Extracted from 6.0-SNAPSHOT)
