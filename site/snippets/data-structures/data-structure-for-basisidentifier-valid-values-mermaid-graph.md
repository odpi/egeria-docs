```mermaid
---
title: DataStructure - Data Structure for basisIdentifier Valid Values [ea0b8eb4-51d2-47ac-8889-4e82bd94c6b0]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for basisIdentifier Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for basisIdentifier Valid Values**"}
...
```
> Data Structure for basisIdentifier Valid Values: The data structure lists the fields in the Valid Metadata Value Set: basisIdentifier product. (Extracted from 6.0-SNAPSHOT)
