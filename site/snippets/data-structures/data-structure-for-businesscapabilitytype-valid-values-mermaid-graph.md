```mermaid
---
title: DataStructure - Data Structure for businessCapabilityType Valid Values [8ef010f2-4d33-4e61-bb81-422d9d06663a]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for businessCapabilityType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for businessCapabilityType Valid Values**"}
2==>|"Collection Membership"|1
3@{ shape: rect, label: "*Data Field*
**Element Last Update Time**"}
1==>|"[3] 0..0 [Member Data Field]"|3
...
```
> Data Structure for businessCapabilityType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: businessCapabilityType product. (Extracted from 6.0-SNAPSHOT)
