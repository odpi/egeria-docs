```mermaid
---
title: DataStructure - Data Structure for byteOrdering Valid Values [f862707c-695d-4983-850b-f080218f94a6]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for byteOrdering Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for byteOrdering Valid Values**"}
...
```
> Data Structure for byteOrdering Valid Values: The data structure lists the fields in the Valid Metadata Value Set: byteOrdering product. (Extracted from 6.0-SNAPSHOT)
