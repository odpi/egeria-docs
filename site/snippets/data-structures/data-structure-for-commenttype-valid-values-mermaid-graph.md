```mermaid
---
title: DataStructure - Data Structure for commentType Valid Values [92c046a8-5e97-4f2d-9d92-31adc066ad9f]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for commentType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for commentType Valid Values**"}
...
```
> Data Structure for commentType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: commentType product. (Extracted from 6.0-SNAPSHOT)
