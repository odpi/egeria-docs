```mermaid
---
title: DataStructure - Data Structure for contactMethodType Valid Values [c350bec2-44e2-4c0b-8762-05ef559b365b]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for contactMethodType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for contactMethodType Valid Values**"}
...
```
> Data Structure for contactMethodType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: contactMethodType product. (Extracted from 6.0-SNAPSHOT)
