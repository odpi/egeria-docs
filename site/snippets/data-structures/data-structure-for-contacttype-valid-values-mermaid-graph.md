```mermaid
---
title: DataStructure - Data Structure for contactType Valid Values [2429abbf-4371-4a03-acaa-4f93b225cea7]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for contactType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for contactType Valid Values**"}
...
```
> Data Structure for contactType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: contactType product. (Extracted from 6.0-SNAPSHOT)
