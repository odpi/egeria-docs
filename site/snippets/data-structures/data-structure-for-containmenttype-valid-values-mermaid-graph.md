```mermaid
---
title: DataStructure - Data Structure for containmentType Valid Values [57a0b25d-d2ef-46b7-9926-dc31d7eed5d2]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for containmentType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for containmentType Valid Values**"}
2==>|"Collection Membership"|1
3@{ shape: rect, label: "*Data Field*
**Data Type**"}
1==>|"[12] 0..0 [Member Data Field]"|3
4@{ shape: rect, label: "*Data Field*
**Scope**"}
1==>|"[13] 0..0 [Member Data Field]"|4
...
```
> Data Structure for containmentType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: containmentType product. (Extracted from 6.0-SNAPSHOT)
