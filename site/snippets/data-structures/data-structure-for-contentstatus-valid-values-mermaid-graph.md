```mermaid
---
title: DataStructure - Data Structure for contentStatus Valid Values [f5ea9c7e-512c-459c-a94d-858b31f6ff6b]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for contentStatus Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for contentStatus Valid Values**"}
...
```
> Data Structure for contentStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: contentStatus product. (Extracted from 6.0-SNAPSHOT)
