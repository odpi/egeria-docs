```mermaid
---
title: DataStructure - Data Structure for coverageCategory Valid Values [4077b5d2-138e-4a32-9c65-2e149e8f12f6]
---
flowchart TD
...
**Data Specification for coverageCategory Valid Values**"}
...
```
> Data Structure for coverageCategory Valid Values: The data structure lists the fields in the Valid Metadata Value Set: coverageCategory product. (Extracted from 6.0-SNAPSHOT)
