```mermaid
---
title: DataStructure - Data Structure for decoration Valid Values [fd4d7c14-031f-4a8d-96c4-75faaf504f11]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for decoration Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for decoration Valid Values**"}
...
```
> Data Structure for decoration Valid Values: The data structure lists the fields in the Valid Metadata Value Set: decoration product. (Extracted from 6.0-SNAPSHOT)
