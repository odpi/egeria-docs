```mermaid
---
title: DataStructure - Data Structure for defaultMediaUsage Valid Values [3e4dcc97-99e1-419a-a21e-82a846ceceb9]
---
flowchart TD
...
```
> Data Structure for defaultMediaUsage Valid Values: The data structure lists the fields in the Valid Metadata Value Set: defaultMediaUsage product. (Extracted from 6.0-SNAPSHOT)
