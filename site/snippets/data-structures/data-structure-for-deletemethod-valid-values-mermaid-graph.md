```mermaid
---
title: DataStructure - Data Structure for deleteMethod Valid Values [db91af72-ef65-4048-ad3f-10d19173738a]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for deleteMethod Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for deleteMethod Valid Values**"}
...
```
> Data Structure for deleteMethod Valid Values: The data structure lists the fields in the Valid Metadata Value Set: deleteMethod product. (Extracted from 6.0-SNAPSHOT)
