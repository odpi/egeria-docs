```mermaid
---
title: DataStructure - Data Structure for deployedImplementationType Valid Values [5a2e9299-1bf4-441e-a26b-ef36f979f6d1]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for deployedImplementationType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for deployedImplementationType Valid Values**"}
...
```
> Data Structure for deployedImplementationType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: deployedImplementationType product. (Extracted from 6.0-SNAPSHOT)
