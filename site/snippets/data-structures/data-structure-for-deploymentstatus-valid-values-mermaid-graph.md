```mermaid
---
title: DataStructure - Data Structure for deploymentStatus Valid Values [f34b60d8-d7b9-481f-8c0d-a8aef0615f08]
---
flowchart TD
...
```
> Data Structure for deploymentStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: deploymentStatus product. (Extracted from 6.0-SNAPSHOT)
