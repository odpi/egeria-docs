```mermaid
---
title: DataStructure - Data Structure for Digital Product List [a2c5799d-4a86-4db7-b11e-4c00da1beffd]
---
flowchart TD
...
**Data Specification for Digital Product List**"}
...
```
> Data Structure for Digital Product List: The data structure lists the fields in the Digital Product List product. (Extracted from 6.0-SNAPSHOT)
