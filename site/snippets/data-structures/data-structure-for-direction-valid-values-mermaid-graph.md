```mermaid
---
title: DataStructure - Data Structure for direction Valid Values [ae7fcc95-fa81-41a1-aacf-06d189e37367]
---
flowchart TD
...
```
> Data Structure for direction Valid Values: The data structure lists the fields in the Valid Metadata Value Set: direction product. (Extracted from 6.0-SNAPSHOT)
