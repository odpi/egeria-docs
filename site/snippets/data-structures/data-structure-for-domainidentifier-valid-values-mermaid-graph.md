```mermaid
---
title: DataStructure - Data Structure for domainIdentifier Valid Values [74b4cc3c-c5f7-4fa0-a57f-7089a250d705]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for domainIdentifier Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for domainIdentifier Valid Values**"}
...
```
> Data Structure for domainIdentifier Valid Values: The data structure lists the fields in the Valid Metadata Value Set: domainIdentifier product. (Extracted from 6.0-SNAPSHOT)
