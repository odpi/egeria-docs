```mermaid
---
title: DataStructure - Data Structure for facilityType Valid Values [cad54b26-4716-4add-9c96-02f018dd6ae4]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for facilityType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for facilityType Valid Values**"}
...
```
> Data Structure for facilityType Valid Values: The data structure lists the fields in the Reference Data Set: facilityType product. (Extracted from 6.0-SNAPSHOT)
