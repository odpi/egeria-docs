```mermaid
---
title: DataStructure - Data Structure for fileName Valid Values [d90b3cd9-5c9b-4a33-9496-40a344da3ca7]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for fileName Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for fileName Valid Values**"}
...
```
> Data Structure for fileName Valid Values: The data structure lists the fields in the Valid Metadata Value Set: fileName product. (Extracted from 6.0-SNAPSHOT)
