```mermaid
---
title: DataStructure - Data Structure for incidentStatus Valid Values [425297a2-a754-4afa-a810-2c6c77fe52f8]
---
flowchart TD
...
**Data Specification for incidentStatus Valid Values**"}
...
```
> Data Structure for incidentStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: incidentStatus product. (Extracted from 6.0-SNAPSHOT)
