```mermaid
---
title: DataStructure - Data Structure for keyPattern Valid Values [74d71929-d0ef-47f2-8dd7-229ea9677fcd]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for keyPattern Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for keyPattern Valid Values**"}
...
```
> Data Structure for keyPattern Valid Values: The data structure lists the fields in the Valid Metadata Value Set: keyPattern product. (Extracted from 6.0-SNAPSHOT)
