```mermaid
---
title: DataStructure - Data Structure for levelIdentifier Valid Values [b7e5f446-01c6-4174-bb2e-6877aad1e700]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for levelIdentifier Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for levelIdentifier Valid Values**"}
...
```
> Data Structure for levelIdentifier Valid Values: The data structure lists the fields in the Valid Metadata Value Set: levelIdentifier product. (Extracted from 6.0-SNAPSHOT)
