```mermaid
---
title: DataStructure - Data Structure for mediaType Valid Values [29a94bd0-2751-4f8e-8eba-3f5c88b08cc6]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for mediaType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for mediaType Valid Values**"}
...
```
> Data Structure for mediaType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: mediaType product. (Extracted from 6.0-SNAPSHOT)
