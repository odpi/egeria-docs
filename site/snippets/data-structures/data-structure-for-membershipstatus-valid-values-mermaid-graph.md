```mermaid
---
title: DataStructure - Data Structure for membershipStatus Valid Values [14ece95d-5fba-4fbc-9aec-faab6461e4f7]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for membershipStatus Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for membershipStatus Valid Values**"}
...
```
> Data Structure for membershipStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: membershipStatus product. (Extracted from 6.0-SNAPSHOT)
