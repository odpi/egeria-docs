```mermaid
---
title: DataStructure - Data Structure for portType Valid Values [9ffd3c49-628a-4679-96e1-1c4ae19fbb77]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for portType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for portType Valid Values**"}
...
```
> Data Structure for portType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: portType product. (Extracted from 6.0-SNAPSHOT)
