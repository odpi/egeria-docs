```mermaid
---
title: DataStructure - Data Structure for projectHealth Valid Values [ced76b71-d3ef-457a-b572-acd582849595]
---
flowchart TD
...
```
> Data Structure for projectHealth Valid Values: The data structure lists the fields in the Valid Metadata Value Set: projectHealth product. (Extracted from 6.0-SNAPSHOT)
