```mermaid
---
title: DataStructure - Data Structure for projectPhase Valid Values [9dc325c3-7bb0-409d-9975-67fcfe0d9e41]
---
flowchart TD
...
```
> Data Structure for projectPhase Valid Values: The data structure lists the fields in the Valid Metadata Value Set: projectPhase product. (Extracted from 6.0-SNAPSHOT)
