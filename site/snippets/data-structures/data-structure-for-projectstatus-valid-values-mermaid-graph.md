```mermaid
---
title: DataStructure - Data Structure for projectStatus Valid Values [f87c8bfc-f07a-4b4e-bbbe-460d454ee598]
---
flowchart TD
...
```
> Data Structure for projectStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: projectStatus product. (Extracted from 6.0-SNAPSHOT)
