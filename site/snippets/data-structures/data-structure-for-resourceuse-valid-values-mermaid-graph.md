```mermaid
---
title: DataStructure - Data Structure for resourceUse Valid Values [8b5703a8-d0ac-4686-8296-9bcd12b84d4a]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for resourceUse Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for resourceUse Valid Values**"}
...
```
> Data Structure for resourceUse Valid Values: The data structure lists the fields in the Valid Metadata Value Set: resourceUse product. (Extracted from 6.0-SNAPSHOT)
