```mermaid
---
title: DataStructure - Data Structure for roleType Valid Values [af6a0ceb-c9b4-464e-8184-0bebaf5c23ce]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for roleType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for roleType Valid Values**"}
...
```
> Data Structure for roleType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: roleType product. (Extracted from 6.0-SNAPSHOT)
