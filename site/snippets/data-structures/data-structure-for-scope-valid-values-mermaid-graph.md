```mermaid
---
title: DataStructure - Data Structure for scope Valid Values [1395d280-a176-470a-9039-e6fbf9e1b953]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for scope Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for scope Valid Values**"}
...
```
> Data Structure for scope Valid Values: The data structure lists the fields in the Valid Metadata Value Set: scope product. (Extracted from 6.0-SNAPSHOT)
