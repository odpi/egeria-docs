```mermaid
---
title: DataStructure - Data Structure for severityIdentifier Valid Values [b0f7c2c7-c444-4b26-ab0a-2afee3b2a170]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for severityIdentifier Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for severityIdentifier Valid Values**"}
...
```
> Data Structure for severityIdentifier Valid Values: The data structure lists the fields in the Valid Metadata Value Set: severityIdentifier product. (Extracted from 6.0-SNAPSHOT)
