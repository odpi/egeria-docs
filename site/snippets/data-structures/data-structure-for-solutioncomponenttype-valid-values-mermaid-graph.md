```mermaid
---
title: DataStructure - Data Structure for solutionComponentType Valid Values [3c2ee8da-076a-4af6-b4c1-e0a837d08731]
---
flowchart TD
...
**Data Specification for solutionComponentType Valid Values**"}
...
```
> Data Structure for solutionComponentType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: solutionComponentType product. (Extracted from 6.0-SNAPSHOT)
