```mermaid
---
title: DataStructure - Data Structure for sortOrder Valid Values [011de4fb-3ed8-461d-904f-4eb32e1d140b]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for sortOrder Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for sortOrder Valid Values**"}
...
```
> Data Structure for sortOrder Valid Values: The data structure lists the fields in the Valid Metadata Value Set: sortOrder product. (Extracted from 6.0-SNAPSHOT)
