```mermaid
---
title: DataStructure - Data Structure for statusIdentifier Valid Values [74349be1-d382-4b2e-865c-4ba300442f6b]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for statusIdentifier Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for statusIdentifier Valid Values**"}
...
```
> Data Structure for statusIdentifier Valid Values: The data structure lists the fields in the Valid Metadata Value Set: statusIdentifier product. (Extracted from 6.0-SNAPSHOT)
