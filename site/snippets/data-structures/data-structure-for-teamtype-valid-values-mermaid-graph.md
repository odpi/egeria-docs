```mermaid
---
title: DataStructure - Data Structure for teamType Valid Values [829bd9f7-c0d1-4e0d-9c2e-a32c9d709993]
---
flowchart TD
...
**Data Specification for teamType Valid Values**"}
...
```
> Data Structure for teamType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: teamType product. (Extracted from 6.0-SNAPSHOT)
