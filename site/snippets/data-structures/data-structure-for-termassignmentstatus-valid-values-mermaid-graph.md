```mermaid
---
title: DataStructure - Data Structure for termAssignmentStatus Valid Values [a2851070-84cb-4f86-a063-6ed6d6eb7bf9]
---
flowchart TD
...
**Data Specification for termAssignmentStatus Valid Values**"}
...
```
> Data Structure for termAssignmentStatus Valid Values: The data structure lists the fields in the Valid Metadata Value Set: termAssignmentStatus product. (Extracted from 6.0-SNAPSHOT)
