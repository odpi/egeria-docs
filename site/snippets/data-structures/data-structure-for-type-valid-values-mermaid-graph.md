```mermaid
---
title: DataStructure - Data Structure for type Valid Values [044d4118-92f0-4226-8148-3b6056bd2dba]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for type Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for type Valid Values**"}
...
```
> Data Structure for type Valid Values: The data structure lists the fields in the Valid Metadata Value Set: type product. (Extracted from 6.0-SNAPSHOT)
