```mermaid
---
title: DataStructure - Data Structure for typeName Valid Values [e5d20f4e-d2ed-4128-a5b6-e2aeb3d97982]
---
flowchart TD
...
**Data Specification for typeName Valid Values**"}
...
```
> Data Structure for typeName Valid Values: The data structure lists the fields in the Valid Metadata Value Set: typeName product. (Extracted from 6.0-SNAPSHOT)
