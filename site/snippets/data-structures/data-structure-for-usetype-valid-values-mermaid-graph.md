```mermaid
---
title: DataStructure - Data Structure for useType Valid Values [2f3989da-8b1b-4d3e-9874-174167f40ea8]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Data Structure*
**Data Structure for useType Valid Values**"}
2@{ shape: rect, label: "*Data Spec*
**Data Specification for useType Valid Values**"}
...
```
> Data Structure for useType Valid Values: The data structure lists the fields in the Valid Metadata Value Set: useType product. (Extracted from 6.0-SNAPSHOT)
