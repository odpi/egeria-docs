```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for File Directory (Folder) Measurements [2195c115-4554-4249-b267-742ef1d398ed]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Governance Action Process*
**Create Daily refresh subscription for File Directory (Folder) Measurements**"}
...
**Notification type for Daily refresh subscription for product File Directory (Folder) Measurements**"}
...
**Product Manager for File Directory (Folder) Measurements**"}
