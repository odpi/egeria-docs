```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Open Metadata Attributes For Types List [d2cf001e-a4bd-4f43-9504-6fd7fb08e08b]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Open Metadata Attributes For Types List**"}
1==>|"subscriptionManagerNotificationType [Target For Governance Action]"|8
9@{ shape: doc, label: "*License Type*
**Creative Commons Attribution 4.0 International License (CC BY 4.0)**"}
1==>|"licenseType [Target For Governance Action]"|9
