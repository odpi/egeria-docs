```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Request For Action Annotations List [11cd7e41-dbbc-42e8-add4-d955be1ea84a]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Request For Action Annotations List**"}
