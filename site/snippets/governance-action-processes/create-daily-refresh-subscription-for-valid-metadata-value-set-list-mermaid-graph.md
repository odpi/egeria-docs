```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set List [887cd5af-2ef1-406b-a237-9810e0576ff6]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set List**"}
