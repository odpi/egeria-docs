```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: assignmentType [859c0730-4783-46ba-a50c-d6f63e96a539]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: assignmentType**"}
