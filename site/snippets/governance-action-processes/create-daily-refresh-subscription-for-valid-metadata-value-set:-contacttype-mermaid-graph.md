```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: contactType [e300d915-0d0f-4eb4-ad24-f77452e5847d]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: contactType**"}
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: contactType**"}
