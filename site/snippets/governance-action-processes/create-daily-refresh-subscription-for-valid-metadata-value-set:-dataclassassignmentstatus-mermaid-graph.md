```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: dataClassAssignmentStatus [11aa89bb-52a4-4429-83a0-5a4e02b43ba2]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: dataClassAssignmentStatus**"}
