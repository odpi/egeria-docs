```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: deleteMethod [6f2d12b1-ee28-4e80-bc51-1465f2dbc4e2]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: deleteMethod**"}
