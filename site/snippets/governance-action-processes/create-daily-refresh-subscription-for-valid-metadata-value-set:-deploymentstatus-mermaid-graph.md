```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: deploymentStatus [5b270e1e-8301-4513-b19e-ec8724f5aa9f]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: deploymentStatus**"}
1==>|"subscriptionManagerNotificationType [Target For Governance Action]"|6
7@{ shape: trap-t, label: "*Digital Product Manager*
**Product Manager for Valid Metadata Value Set: deploymentStatus**"}
