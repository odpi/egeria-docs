```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: fileExtension [51b8e7ec-2867-43f0-9e83-c5d6f062fd6f]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: fileExtension**"}
