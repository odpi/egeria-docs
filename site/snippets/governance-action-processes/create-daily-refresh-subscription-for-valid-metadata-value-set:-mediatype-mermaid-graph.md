```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: mediaType [bcb0a1c9-74db-4f57-959e-fea1213c0724]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: mediaType**"}
