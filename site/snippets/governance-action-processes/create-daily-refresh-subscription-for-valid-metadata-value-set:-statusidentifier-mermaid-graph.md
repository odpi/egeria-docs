```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: statusIdentifier [9d4276cd-d7ec-43f6-a351-1dbda117ca68]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: statusIdentifier**"}
