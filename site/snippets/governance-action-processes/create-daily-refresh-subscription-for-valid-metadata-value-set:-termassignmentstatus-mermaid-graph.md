```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: termAssignmentStatus [603b1c1e-31c9-4cc6-a7a9-b77001738d9d]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: termAssignmentStatus**"}
