```mermaid
---
title: Specification for - Create Evaluation subscription for Valid Metadata Value Set: businessCapabilityType [7815bf86-91fc-43d8-9856-283a88876c3f]
---
flowchart LR
...
**service-failed**"}
2==>3
subgraph 4 [service-failed details]
