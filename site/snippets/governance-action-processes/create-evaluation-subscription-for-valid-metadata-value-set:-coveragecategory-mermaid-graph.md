```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: coverageCategory [760372aa-c763-4251-9f92-679795b2ca17]
---
flowchart TD
...
**Notification type for Evaluation subscription for product Valid Metadata Value Set: coverageCategory**"}
1==>|"subscriptionManagerNotificationType [Target For Governance Action]"|8
9@{ shape: trap-t, label: "*Digital Product Manager*
**Product Manager for Valid Metadata Value Set: coverageCategory**"}
