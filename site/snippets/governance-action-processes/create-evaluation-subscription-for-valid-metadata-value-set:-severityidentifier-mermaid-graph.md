```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: severityIdentifier [712c25a8-a12a-47d4-8352-ea05580895c2]
---
flowchart TD
...
**Notification type for Evaluation subscription for product Valid Metadata Value Set: severityIdentifier**"}
