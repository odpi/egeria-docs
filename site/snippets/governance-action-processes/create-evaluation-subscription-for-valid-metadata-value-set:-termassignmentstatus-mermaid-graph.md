```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: termAssignmentStatus [e23780b5-b732-4855-92e2-822cf5889f66]
---
flowchart TD
...
**Notification type for Evaluation subscription for product Valid Metadata Value Set: termAssignmentStatus**"}
