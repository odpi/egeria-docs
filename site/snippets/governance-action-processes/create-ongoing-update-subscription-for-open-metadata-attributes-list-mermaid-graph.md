```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Open Metadata Attributes List [89c4f2aa-fea4-454c-935c-bcecad7b8a02]
---
flowchart TD
...
**Notification type for Ongoing update subscription for product Open Metadata Attributes List**"}
...
**Product Manager for Open Metadata Attributes List**"}
