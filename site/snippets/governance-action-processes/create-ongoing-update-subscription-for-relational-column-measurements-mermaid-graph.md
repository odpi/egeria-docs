```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Relational Column Measurements [94abfc80-d76c-4978-963c-ea66dce06cfc]
---
flowchart TD
...
1==>|"provisioningGovernanceActionType [Target For Governance Action]"|8
9@{ shape: cyl, label: "*Reference Code Table*
**Data set for Resource measurement annotations for surveyed Relational Columns**"}
1==>|"sourceDataSet [Target For Governance Action]"|9
...
1==>|"producedActionTarget [Specification Property Assignment]"|14
