```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Valid Metadata Value Set: dataClassAssignmentStatus [e5050281-6f65-4286-a5a4-979e9b63059d]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: dataClassAssignmentStatus**"}
...
1==>|"subscriptionManagerNotificationType [Target For Governance Action]"|8
