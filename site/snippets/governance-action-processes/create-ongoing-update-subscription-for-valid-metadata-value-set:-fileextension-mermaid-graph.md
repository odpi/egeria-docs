```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Valid Metadata Value Set: fileExtension [e2c9a5d5-bfcc-44bd-a133-c7bbd397cae3]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: fileExtension**"}
1==>|"digitalProductOwner [Target For Governance Action]"|9
