```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Valid Metadata Value Set: termAssignmentStatus [fa5414d6-0237-4649-92c9-18a78f413d7f]
---
flowchart TD
...
5@{ shape: doc, label: "*Service Level Objective*
**Updates are delivered within 1 hour of receipt**"}
1==>|"serviceLevelObjective [Target For Governance Action]"|5
