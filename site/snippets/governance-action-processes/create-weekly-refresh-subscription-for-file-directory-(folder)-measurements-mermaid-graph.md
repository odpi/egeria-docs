```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for File Directory (Folder) Measurements [b72966c0-53d9-4003-a7f7-a7dafd8b70df]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product File Directory (Folder) Measurements**"}
