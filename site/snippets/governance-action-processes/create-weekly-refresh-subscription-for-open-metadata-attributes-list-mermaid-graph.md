```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Open Metadata Attributes List [aaf62329-563c-4c81-86bc-902b8ede0afb]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Governance Action Process*
**Create Weekly refresh subscription for Open Metadata Attributes List**"}
