```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Valid Metadata Value Set: contentStatus [ddf04028-015e-46b8-89f9-033f7e81f187]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Valid Metadata Value Set: contentStatus**"}
