```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Valid Metadata Value Set: deploymentStatus [fca6645b-c2a4-44bc-8dc1-425cbaea7fc4]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Valid Metadata Value Set: deploymentStatus**"}
