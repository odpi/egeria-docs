```mermaid
---
title: Specification for - FileDirectory::CreateAsCatalogTarget [746a8aa0-7ed6-44cb-acd2-098a3c119fa6]
---
flowchart LR
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: processes, label: "*Governance Action Process*
**FileDirectory::CreateAsCatalogTarget**"}
...
**fileSystemName**"}
2==>15
subgraph 16 [fileSystemName details]
...
**directoryName**"}
2==>27
subgraph 28 [directoryName details]
