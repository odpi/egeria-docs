```mermaid
---
title: Specification for - PostgreSQLServer::CreateAsCatalogTarget [af774c5a-1a7c-4517-a7c4-7fca50207f1a]
---
flowchart LR
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: processes, label: "*Governance Action Process*
**PostgreSQLServer::CreateAsCatalogTarget**"}
...
**hostIdentifier**"}
2==>9
subgraph 10 [hostIdentifier details]
...
**description**"}
2==>15
subgraph 16 [description details]
...
**serverName**"}
2==>33
subgraph 34 [serverName details]
