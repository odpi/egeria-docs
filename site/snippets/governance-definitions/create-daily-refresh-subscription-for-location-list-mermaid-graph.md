```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Location List [2ba2261e-ca85-4d4b-a508-76eb8ad24a7e]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Location List**"}
