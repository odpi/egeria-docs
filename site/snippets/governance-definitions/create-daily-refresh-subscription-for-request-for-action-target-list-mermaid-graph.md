```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Request For Action Target List [0834da6c-e79f-40c6-b44e-9409497a0a79]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Request For Action Target List**"}
