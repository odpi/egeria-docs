```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: additionalProperties [92cdb75f-d1c2-49a1-92ee-0655a372effa]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: additionalProperties**"}
