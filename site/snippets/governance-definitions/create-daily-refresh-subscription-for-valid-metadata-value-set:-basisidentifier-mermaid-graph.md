```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: basisIdentifier [6dd767d5-d4bf-4e97-9976-08c79aae05e2]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: basisIdentifier**"}
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: basisIdentifier**"}
