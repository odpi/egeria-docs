```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: businessCapabilityType [db5c3df9-efbc-47fc-a7dc-7da630573661]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: businessCapabilityType**"}
