```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: contactMethodType [8fc6f02b-04fe-4264-b2c4-88d7cc6791fb]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: contactMethodType**"}
