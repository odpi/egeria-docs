```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: coverageCategory [a9abaac2-7627-4842-9876-2b7509eb6fd3]
---
flowchart TD
...
**Notification type for Daily refresh subscription for product Valid Metadata Value Set: coverageCategory**"}
