```mermaid
---
title: GovernanceActionProcess - Create Daily refresh subscription for Valid Metadata Value Set: solutionComponentType [61b4dc1f-045e-4b19-bc74-c2797119a772]
---
flowchart TD
...
1==>|"cancellingGovernanceActionType [Target For Governance Action]"|6
...
9@{ shape: doc, label: "*Service Level Objective*
**A complete refresh of the product data is delivered to the product data''s destination each day**"}
1==>|"serviceLevelObjective [Target For Governance Action]"|9
