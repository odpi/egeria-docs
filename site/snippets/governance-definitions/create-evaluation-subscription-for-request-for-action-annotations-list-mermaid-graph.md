```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Request For Action Annotations List [98eec35d-a643-44b3-a16f-b79736d59e5d]
---
flowchart TD
...
**Notification type for Evaluation subscription for product Request For Action Annotations List**"}
