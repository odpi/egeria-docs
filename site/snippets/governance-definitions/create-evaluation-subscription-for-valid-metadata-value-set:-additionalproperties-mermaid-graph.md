```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: additionalProperties [c8cbc5e6-b1d7-4478-8db3-66a99eaac1cd]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: additionalProperties**"}
...
**Notification type for Evaluation subscription for product Valid Metadata Value Set: additionalProperties**"}
