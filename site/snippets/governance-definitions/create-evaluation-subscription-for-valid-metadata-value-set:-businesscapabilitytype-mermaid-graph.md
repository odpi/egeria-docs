```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: businessCapabilityType [1038de9a-47da-444c-a54f-5d9d6203f34b]
---
flowchart TD
...
**Notification type for Evaluation subscription for product Valid Metadata Value Set: businessCapabilityType**"}
