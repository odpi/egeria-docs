```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: projectPhase [018613db-166d-44d1-b887-763fce0e027c]
---
flowchart TD
...
**Notification type for Evaluation subscription for product Valid Metadata Value Set: projectPhase**"}
