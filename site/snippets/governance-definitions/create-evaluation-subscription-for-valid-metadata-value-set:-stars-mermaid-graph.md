```mermaid
---
title: GovernanceActionProcess - Create Evaluation subscription for Valid Metadata Value Set: stars [35368d84-e748-4f8f-b52c-6410ba84eec6]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: stars**"}
1==>|"digitalProductOwner [Target For Governance Action]"|5
6@{ shape: doc, label: "*Notification Type*
**Notification type for Evaluation subscription for product Valid Metadata Value Set: stars**"}
