```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Open Metadata Attributes For Types List [ede382ed-5d85-4a93-b3f8-e513bc8e5430]
---
flowchart TD
...
**Product Manager for Open Metadata Attributes For Types List**"}
1==>|"digitalProductOwner [Target For Governance Action]"|4
5@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Open Metadata Attributes For Types List**"}
