```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Request For Action Annotations List [3f8cedef-7d93-4609-a5c6-26d1ac456e9d]
---
flowchart TD
...
**Notification type for Ongoing update subscription for product Request For Action Annotations List**"}
