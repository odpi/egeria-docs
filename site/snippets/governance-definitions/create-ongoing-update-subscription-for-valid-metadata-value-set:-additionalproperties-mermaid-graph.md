```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Valid Metadata Value Set: additionalProperties [8c3680c5-e3d7-4ed2-9cdc-a497f4edf232]
---
flowchart TD
