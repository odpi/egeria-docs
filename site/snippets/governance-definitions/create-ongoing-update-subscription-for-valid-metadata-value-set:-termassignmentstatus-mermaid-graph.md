```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Valid Metadata Value Set: termAssignmentStatus [1d819924-cdc8-4507-8493-2922c24040e0]
---
flowchart TD
%%{init: {"flowchart": {"htmlLabels": false}} }%%

1@{ shape: rounded, label: "*Governance Action Process*
**Create Ongoing update subscription for Valid Metadata Value Set: termAssignmentStatus**"}
2@{ shape: rect, label: "*Digital Product*
**termAssignmentStatus Valid Values**"}
2==>|"Create Subscription [Resource List]"|1
3@{ shape: rect, label: "*Glossary Term*
**Ongoing Update Subscription**"}
1==>|"Semantic Assignment"|3
4@{ shape: doc, label: "*License Type*
**Data for Internal Use**"}
1==>|"licenseType [Target For Governance Action]"|4
5@{ shape: tag-rect, label: "*Governance Action Type*
**cancel-digital-subscription (EgeriaGovernance)**"}
1==>|"cancellingGovernanceActionType [Target For Governance Action]"|5
6@{ shape: cyl, label: "*Reference Code Table*
**Data set for termAssignmentStatus Valid Values**"}
1==>|"sourceDataSet [Target For Governance Action]"|6
7@{ shape: doc, label: "*Service Level Objective*
**Updates are delivered within 1 hour of receipt**"}
1==>|"serviceLevelObjective [Target For Governance Action]"|7
8@{ shape: trap-t, label: "*Digital Product Manager*
**Product Manager for Valid Metadata Value Set: termAssignmentStatus**"}
1==>|"digitalProductOwner [Target For Governance Action]"|8
9@{ shape: doc, label: "*Notification Type*
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: termAssignmentStatus**"}
1==>|"subscriptionManagerNotificationType [Target For Governance Action]"|9
...
1==>|"producedActionTarget [Specification Property Assignment]"|13
...
1==>|"supportedActionTarget [Specification Property Assignment]"|17
