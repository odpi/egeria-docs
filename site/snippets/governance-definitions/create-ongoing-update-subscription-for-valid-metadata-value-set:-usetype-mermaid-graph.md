```mermaid
---
title: GovernanceActionProcess - Create Ongoing update subscription for Valid Metadata Value Set: useType [33e343fa-a04f-43c8-a5c5-a557212dca34]
---
flowchart TD
...
**Notification type for Ongoing update subscription for product Valid Metadata Value Set: useType**"}
