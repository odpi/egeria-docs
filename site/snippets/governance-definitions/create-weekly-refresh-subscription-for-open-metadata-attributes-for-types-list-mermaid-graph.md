```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Open Metadata Attributes For Types List [5e2ad8fe-7ade-4a46-8043-4c2ea01aed9a]
---
flowchart TD
...
5@{ shape: cyl, label: "*Tabular Data Set*
