```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Open Metadata Attributes List [cc2d581c-f505-4a10-84c1-19e53000f29a]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Open Metadata Attributes List**"}
