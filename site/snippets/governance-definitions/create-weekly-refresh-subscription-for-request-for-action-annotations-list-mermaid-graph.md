```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Request For Action Annotations List [e7ff6aa1-772e-4e7b-9029-b45dae7b11d5]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Request For Action Annotations List**"}
