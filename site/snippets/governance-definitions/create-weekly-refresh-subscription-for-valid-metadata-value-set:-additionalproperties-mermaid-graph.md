```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Valid Metadata Value Set: additionalProperties [4cf8dc36-1919-4cad-8348-9374b40779c8]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Valid Metadata Value Set: additionalProperties**"}
