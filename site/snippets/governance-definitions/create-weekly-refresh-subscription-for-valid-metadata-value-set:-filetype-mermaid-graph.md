```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Valid Metadata Value Set: fileType [5f31c937-5e07-41ee-9c30-a84314584ecf]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Valid Metadata Value Set: fileType**"}
...
**Product Manager for Valid Metadata Value Set: fileType**"}
