```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Valid Metadata Value Set: portType [75629800-2187-47b9-aa49-a34400ffa21f]
---
flowchart TD
...
**Notification type for Weekly refresh subscription for product Valid Metadata Value Set: portType**"}
...
**Product Manager for Valid Metadata Value Set: portType**"}
