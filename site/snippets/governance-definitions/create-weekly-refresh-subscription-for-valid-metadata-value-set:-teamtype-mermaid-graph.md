```mermaid
---
title: GovernanceActionProcess - Create Weekly refresh subscription for Valid Metadata Value Set: teamType [288703d7-d282-47ea-96cd-41018806af6c]
---
flowchart TD
...
**Product Manager for Valid Metadata Value Set: teamType**"}
...
**Notification type for Weekly refresh subscription for product Valid Metadata Value Set: teamType**"}
