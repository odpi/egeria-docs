```mermaid
---
title: NotificationType - Notification type for Weekly refresh subscription for product Valid Metadata Value Set: typeName [0bcd9edd-da49-4fc6-8283-b0e936d74870]
---
flowchart TD
...
1==>|"product manager notifications [Notification Subscriber]"|7
8@{ shape: rounded, label: "*Note Log*
**Notifications for Open Metadata Reference Data special interest group**"}
1==>|"community notifications [Notification Subscriber]"|8
