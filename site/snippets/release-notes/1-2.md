...
* The metadata servers and future governance servers running on the OMAG Server Platform
  support [metadata-centric security](https://github.com/odpi/egeria/tree/main/open-metadata-implementation/common-services/metadata-security)
...
??? info "Egeria Implementation Status at Release 1.2"
