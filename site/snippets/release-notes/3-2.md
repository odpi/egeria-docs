...
???+ functional "Functional changes"
    ...
    ??? deprecated "Docker compose"
        The docker-compose environment was deprecated in release 3.1. It will be removed in release 3.3. See [odpi/egeria#5721 :material-dock-window:](https://github.com/odpi/egeria/issues/5721){ target=gh }. 
