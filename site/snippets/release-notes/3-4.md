...
???+ functional "Functional changes"
    ...
    A new REST API 'GET {{baseURL}}/open-metadata/admin-services/servers/{{serverName}}}}/instance/status' has been added to returned more detailed status for a server.
