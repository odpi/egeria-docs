...
??? functional "Open Metadata Types"
    ...
    * A new *sourceVersionNumber* attribute has been added to the [*SourcedFrom*](/types/0/0011-Templates) relationship type to allow the version of the element that is copied to be recorded.
    * A new classification called [*TemplateSubstitute*](/types/0/0011-Templates) has been added to isolate relationships included in templates from normal metadata queries.
